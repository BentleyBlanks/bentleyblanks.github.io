  ...
  return [
    {
      ...
      lines: [
        ...
        // 三个机位都收进剪短后的村界（2026-08-18 第二趟：能走的街 [6.2, 72]）：
        // 90/130/100 → 86/104/96 → 现在 66/52/62，后两趟的老数落在已经删掉的
        // 那片空场上。三镜的落点跟着台词走：村东口那片庄稼地（新窖口）→
        // 七叔家那个废弃的窖口(52.6)→回村路上的街面
        { stage: "沙河庄的地道重新修整。被发现的口子封死了，新口挖在另一片庄稼地旁。", d: 4.6, cam: { kind: "wide", x: 66 } },
        { stage: "乡亲们把废弃的旧口填平。那块地方，正是当年柱子第一次找到妹妹的地方。", d: 4.8, cam: { kind: "wide", x: 52, pan: 5 } },
        { stage: "柱子带着妹妹，回了一趟梁家村。", d: 3.4, cam: { kind: "wide", x: 62, pan: -8 } },
      ],
