...
const SOUND_KEY = "tunnelLight1943_chapterOneImagegen_sound";
// 三路音量各自记住。默认配乐低一些——它只是底噪，不该压住旁白。
const VOL_KEY = "tunnelLight1943_chapterOneImagegen_vol";
...
// 进度
// ---------------------------------------------------------------------------
const STORE_KEY = "tunnelLight1943_chapterOneImagegen_unlocked";
...
function BuildTitle() {
  ...
  CHAPTERS.slice(0, PLAYABLE_CHAPTERS).forEach((ch, i) => {
    const btn = document.createElement("button");
    btn.type = "button";
...
const BAG_KEY = "tunnelLight1943_chapterOneImagegen_bag_v1";
function LoadBag() {
