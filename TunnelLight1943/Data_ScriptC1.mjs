  ...
  return [
    ...
    },
    {
      ...
      lines: [
        ...
        // ── 2026-08-16 新增两句（用户：「第一章里的伤员也没有解释」）───────────
        // 本文件开头那段注释早就把历史交代压在七叔这儿了（"告示墙、弹孔、七叔
        // 那句甭往北头去"），可他只说了"别去"，没说**为什么**——于是四拍之后
        // 草苫底下伸出来的那只手是凭空冒出来的：玩家救了一个人，从头到尾不知道
        // 他是谁、哪来的。现在因果摆在前头，而且是**村里人嘴里的传言**，不是旁白：
        // 昨夜北洼打了一仗、今早据点挨家问一个"带伤的"。夜里他就在自家窖里。
        // 这条线第二章由翻译官那句喊话接过去（Data_ScriptC2 的 c2_open）。
        // 顺带把车铃那一拍也解释了：两个伪军停在村口张望，正是在找人。
        { who: "七叔", say: "昨儿后半夜，北洼响了半宿枪。", d: 3.2,
          cam: CINE(46.92, 0.45, 2.90, [FG.jambL(1.68, 0.30, 0.96, 2.09)]) },
        { who: "七叔", say: "今儿一早据点就出来人，挨家问——说是跑了一个，带着伤。", d: 4.6,
          cam: CINE(46.92, 0.45, 2.90, [FG.jambL(1.68, 0.30, 0.96, 2.09)]) },
    ...
    },
    {
      ...
      lines: [
        ...
        // ── 2026-08-16 新增四行：这个人得自己交代一句（同上，用户退回）────────
        // 夜里那声「水。」是他全章唯一的台词，天亮了还不说话，玩家救完人仍旧
        // 不知道救的是谁——前一天七叔那句"跑了一个带伤的"就白说了，而第二章
        // 鬼子进村找的正是他。他只说三件事：**哪来的、哪一仗、别声张**；
        // "八路"这两个字留给第二章翻译官去点名（一个昏过去半宿的人不会自报
        // 番号，村里孩子也听不懂番号——"队伍上的"才是那时候的说法）。
        // 「别声张」还接着章名《善意的谎言》：柱子从此对妹妹又多瞒了一件事。
        // **脸只能走插卡**（窖底三米六外一颗脑袋二十来个像素，CLAUDE.md
        // 「人脸只能走插卡」）：照 §9 那张 strangerFace，seg 0 是脸、seg 1 张嘴。
        { act: "草苫上那个人睁开了眼。", d: 2.4,
          cam: { kind: "insertCard", card: "strangerFace", seg: 0 } },
        { who: "陌生人", say: "我是队伍上的。北洼那一仗，打散了。", d: 4.2,
          cam: { kind: "insertCard", card: "strangerFace", seg: 1 } },
        { who: "陌生人", say: "有人问起，就说没见过我。", d: 3.4,
          cam: { kind: "insertCard", card: "strangerFace", seg: 1 } },
        // 回到窖里同一格：他闭上眼，这一段就此打住（柱子没答话——全章他只
        // 开口三次，那三次都是玩家自己按出来的）
        { act: "那个人闭上眼。胸口重新慢下来。", d: 3.2,
          cam: CINE(27.40, UNDER_Y + 0.34, 2.90, [FG.strawLow(1.70, 1.0, 0.26)]),
          on: (state) => { Cue(state, "sobBreath", { gain: 0.2, rate: 0.7, delay: 1.4 }); } },
