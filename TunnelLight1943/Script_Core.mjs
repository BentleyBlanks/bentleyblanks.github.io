...
// 速度按真人爬梯给（2026-08-18 用户：「哪有那么快下爬的」）：下 0.85m/s ＝ 0.34m 一档
// 每档 0.4 秒，每只脚隔一档跨一步、四肢轮着动看得清；上来费劲，再慢一档。老版是定时
// 1.5 秒滑到底（2.4m/s），手脚再怎么钉在横档上也是一团糊。3.6 米的井按住不松 4.2 / 5 秒。
const CLIMB_SPEED_DOWN = 0.85;
const CLIMB_SPEED_UP = 0.72;
