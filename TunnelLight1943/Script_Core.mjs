      ...
      steps: [
        ...
        { type: "goto", zone: { x: 46.2, w: 2.0 },
          effect: (state) => {
            ...
            StartMicroCine(state, [
              { act: "到了阴影里，柱子把水桶轻轻放在地上。水面仍在晃。", d: 2.8,
