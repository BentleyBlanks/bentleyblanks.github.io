...
// 玩家认得出）。玩法景别画宽 9.6m（2026-08-14 收了一档，原 12.3m）：苫子
// 1.6m＝17%、门板 1.5m＝16%、土堆 1.2m＝13%——三样都过线，所以它们留在世界里，
  ...
  c1: [
    {
      ...
      lines: [
        ...
        { act: "画面从黑暗里显出来。屋门关着，门闩没有插——外面每一声撞击，门板就轻轻震一下。柱子站在屋当间。妹妹缩在炕沿下，两只手捂着耳朵。", d: 4.2,
          cam: {
            ...
            fg: [
              ...
              { art: "doorJamb", side: "right", u: 0.80, v: 0.05, z: 1.30, w: 0.30, h: 0.95, flip: true },
            ],
          },
          on: (state) => {
        ...
        // 纸戏台斜着看有厚度，正打永远是一张平贴
        { who: "娘", say: "柱子。", d: 1.8,
          cam: { kind: "free", from: [30.75, 0.92, 2.62], to: [30.78, 0.91, 2.44], at: [31.42, 0.84],
            fg: [{ art: "wallEdge", u: -0.80, v: 0, z: 1.30, w: 0.34, h: 0.85 }] },
          on: (state) => {
            const m = FindActor(state, "mother");
        ...
        { who: "娘", say: "抱她。", d: 2.0,
          cam: { kind: "free", from: [31.15, 0.84, 2.80], to: [31.18, 0.84, 2.66], at: [32.05, 0.70],
            fg: [{ art: "doorJamb", u: 0.86, v: 0.05, z: 1.20, w: 0.30, h: 0.95, flip: true }] } },
