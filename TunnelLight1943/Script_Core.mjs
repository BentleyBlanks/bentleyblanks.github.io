...
export const SCRIPTS = {
  ...
  c1: [
    ...
    },
    {
      ...
      // 自家牲口棚——路上经过踩碎的纺车、墙上的弹孔，各提一句手记（道具画在
      // 路边自己会说话；路过的注视不许接管镜头，见 steps 里那条 2026-08-13）。
      //
      ...
      steps: [
        // 路过纺车/弹孔墙：一条手记，脚不停（2026-08-13 用户退回：出门几步
        // 连吃两个黑屏过场，直接打断——**路过的注视不许接管镜头**，道具就在
        // 画面里，弱提醒走链步骤的 note→toast，跟 lookables 一个口径）
        { type: "goto", zone: { x: 26.4, w: 1.8 },
          note: "三婶家门口，纺车倒在门槛边。踏板叫人踩碎了。" },
