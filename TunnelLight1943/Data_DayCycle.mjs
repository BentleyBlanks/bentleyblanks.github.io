...
export const LIGHT_MOOD = {
  ...
  tunnel: { dark: 0.58, tint: 0x14100a },   // 地道：土黑
  dark: { dark: 0.74, tint: 0x070504 },     // 熄了灯的地道
};
// 2026-08-18（用户贴《勇敢的心》那一幕：「参考一下勇敢的心怎么做的，然后做好」）：
// 这两档各往下压了一大截（tunnel 0.42→0.58 / dark 0.52→0.74）。
// 参考图里地堡是**近乎全黑**的，能看见的东西全在洞口那一片光里——"打进来的光"
// 之所以成立，靠的是**它周围没有光**。老档下窖里的后墙还是一片暖灰，光再怎么
// 调都是"亮墙上又亮了一块"，读不成一束光。**有光就得有黑给它打进来**（本档
// 早年立的规矩）这次才算真给够。
// 顺带把两档的罩色也压深一档：土黑要真的黑，不然压得越狠越发灰。
