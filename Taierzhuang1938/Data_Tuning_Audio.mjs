...
export const TRENCH_ZONE = Object.freeze({
  radiiM: Object.freeze([2.0, 3.2, 4.6]),
  /** 两侧都要比中心地面高这么多才算沟。沟深 2.0 m，塌低段也还有 1 m 上下。 */
  minRiseM: 0.9,
  /** 查询点比脚下地面高出这么多就不算「在沟里」（飞机、屋顶上的东西）。站着的眼睛是 1.6 m。 */
  maxAboveGroundM: 4.0,
