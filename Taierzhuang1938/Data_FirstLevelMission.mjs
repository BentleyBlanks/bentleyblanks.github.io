...
export const MISSION_ENCOUNTERS = Object.freeze({
  ...
  bunkerAssault: [
    ...
    { id: "BunkerFollowA", role: "ijaC", ...A.bunkerFold, modelVariant:1, weapon: "Type38", bayonet: true,
      enter: [{x:24.2,z:-130.6},{x:23.5,z:-130},A.bunkerFold] },
    { id: "BunkerFollowB", role: "ijaD", ...A.bunkerJunction, modelVariant:2, weapon: "Type38", bayonet: true,
