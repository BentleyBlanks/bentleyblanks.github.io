...
export const CS_Ch6_LastWire = {
  ...
  shots: [
    ...
    },
    {
      ...
      note: "同一立足点（小秦站在桌南，三镜共用 —— 只调视线方向，不挪脚）转向桌东侧的王铭章："
        + "画左是桌上的电台，画中偏下是电键，画右是他的右后肩与侧影，不给正脸。"
        + "他问电台还能不能发 —— 问的是机器，所以机器要在画里。"
        + "★ 原来的 look [1.02,1.28,-1.02] 抬得太高、又正压在他身上："
        + "1.28 m 高于他这一刻的头顶，于是整帧是北墙的黑砖、人只剩一顶帽子、桌子完全不在画内。"
        + "视线落到桌面之上、并往桌心让一点，桌面（电台＋电键）与他的侧影才同时进画。"
        + "★ 2026-08-29 姿态修好之后重对完毕（上一版这里留的待办就是这条）："
        + "他不再是那个「头顶 0.80 m 的瘫坐」，头骨 1.36 m、与参谋（1.26 m）站得一样高，"
        + "于是 0.90 的视线太低 —— 人被顶出画右、帽子还被上沿切掉。"
        + "视线抬到 1.10 并往他那边让 0.16 m：画左桌面与电台，画右他的右后肩与侧影，仍不给正脸",
      camera: { from: [0.55, 1.62, 0.80], look: [0.71, 1.10, -1.10], shake: 0.05 },
