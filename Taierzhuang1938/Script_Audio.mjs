 ...
 */
const DEAFEN_ON = { explosionNear: true, explosionMid: true, shellImpact: true };
...
export class AudioEngine {
  ...
  Reactions(name, distance, spatial, selfShot, weaponClass = null,
    ...
    if (strength > 0) {
      this.Deafen(BLAST_HEARING.minHoldS + BLAST_HEARING.holdSpanS * strength,
  ...
  Deafen(seconds = 0.4, holdS = DEAFEN_ATTACK_HOLD_S, strength = 1) {
    ...
    this.deafenTimer = this.Later((until + H.recoveryS - t) * 1000 + 220, () => this.ResetDeafen());
  }
