...
| `Font_TitleText.woff2` | 准星下的情境提示、识别卡（名字 / 岁数）、剧情字幕（与 logo 同款，2026-09-13 用户定；不预加载） | 思源宋体 Black / Noto Serif SC Black | 296 KB · 1660 字 |
| `Font_UiSans_Regular.woff2`<br>`Font_UiSans_Bold.woff2` | 界面汉字（菜单 / 加载 / 编辑器 / HUD） | 思源黑体 / Noto Sans SC | 461 KB · 1660 字 |
