// Notion《白刃战系统｜大刀与刺刀》2026-09-04。纯数据；规则、动画和测试共读。
...
export const MELEE_WEAPONS = Object.freeze({
  Dadao: Object.freeze({ label: "大刀", pushReach: 0.95, minReach: 0.48,
  ...
  Bayonet: Object.freeze({ label: "刺刀", pushReach: 1.08, minReach: 0.78,
