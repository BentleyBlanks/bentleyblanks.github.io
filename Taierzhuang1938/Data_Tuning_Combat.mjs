...
export const BLAST = Object.freeze({
  ...
  // 以前「有墙挡着」连压制一起取消，炮击掩体等于没打。只对带了 occludedSuppression 开关的那一发生效
  // （FireShell / Blast 的选项；目前只有第一关战车主炮传），别的炮击 / 手榴弹口径不变。
  // 压制量 = occludedSuppression × (1 − d / occludedSuppressionM)。
