...
export const SFX_SOURCES = [
  ...
  },
  {
    ...
    credit: "Volcengine SeedAudio 1.0 · approved Village mid explosion +6 dB · 2026-09-12",
    license: "volcengine",
    bitrate: "192k",
    cuts: [{ cue: "explosionMid", files: ["AudioSfx_ExplosionMidVillage.mp3"], durS: 2.687 }],
  },
  {
    id: "ExplosionFarSeedAudio",
    seedAudio: true,
    bake: "Script_SeedAudioExplosionBake.mjs",
    credit: "Volcengine SeedAudio 1.0 · approved Field far explosion +6 dB · 2026-09-12",
    license: "volcengine",
    bitrate: "192k",
    cuts: [{ cue: "explosionFar", files: ["AudioSfx_ExplosionFarField.mp3"], durS: 3.307 }],
  },
  {
