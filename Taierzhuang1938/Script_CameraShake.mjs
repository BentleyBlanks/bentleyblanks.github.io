...
export class CameraShake {
  ...
  /** 是否还在动（取证 / 测试用）。 */
  get Active() {
    return this.trauma > 0 || this.blastTrauma > 0 || this.rumble > 0 || Object.values(this.springs).some((s) => s.x !== 0 || s.v !== 0);
  }
  ...
  State() {
    return {
      trauma: this.trauma, blastTrauma: this.blastTrauma, pitch: this.pitch, yaw: this.yaw, roll: this.roll, rise: this.rise, rumble: this.rumble,
