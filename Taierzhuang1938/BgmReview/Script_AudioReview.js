...
const groupInfo = {
  ...
  night: { kind: "bgm", title: "夜战紧张 · 潜行与未知", desc: "少旋律、长音与暗涌，给脚步和远处枪炮留空间。", order: 30 },
...
const audioItems = [
  ...
  {
    id: "bgmLongNoteOne", code: "B07", kind: "bgm", group: "night", title: "Long Note One", author: "Kevin MacLeod",
    file: "./Audio/Bgm/AudioBgm_CandidateLongNoteOne.mp3",
    desc: "以长音维持神经紧绷，给夜风、脚步和远处战斗留下位置。",
    tags: ["长音", "留白", "夜行"], source: "Incompetech 独立配乐库",
    sourceUrl: IncompetechUrl("Long Note One"), license: "CC BY 4.0（以来源页为准）", licenseUrl: incompetechLicenseUrl,
  },
  {
    id: "bgmLongNoteTwo", code: "B08", kind: "bgm", group: "night", title: "Long Note Two", author: "Kevin MacLeod",
    file: "./Audio/Bgm/AudioBgm_CandidateLongNoteTwo.mp3",
    desc: "比第一条更像持续暗涌；适合夜间转移、巷口搜索和低能见度。",
    tags: ["暗涌", "低能见度", "潜行"], source: "Incompetech 独立配乐库",
    sourceUrl: IncompetechUrl("Long Note Two"), license: "CC BY 4.0（以来源页为准）", licenseUrl: incompetechLicenseUrl,
  },
  {
    id: "bgmThunderDreams", code: "B09", kind: "bgm", group: "night", title: "Thunder Dreams", author: "Kevin MacLeod",
    file: "./Audio/Bgm/AudioBgm_CandidateThunderDreams.mp3",
    desc: "风暴般的低层压力；可试雨夜、轰炸后街区和未知敌情。",
    tags: ["风暴", "低频", "未知"], source: "Incompetech 独立配乐库",
    sourceUrl: IncompetechUrl("Thunder Dreams"), license: "CC BY 4.0（以来源页为准）", licenseUrl: incompetechLicenseUrl,
  },
  {
