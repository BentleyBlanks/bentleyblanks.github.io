...
export const MISSION_DIALOGUE = Object.freeze([
  ...
  Cue("TrainBanter", [
    ...
    ["liuwencai", "那你把手拿开嘛。"],
    ["heyoutian", "哪个稀罕你那点——"],
  ], {delivery:"两名四川男兵站在车厢墙边，刘文财低头清点子弹，何有田随口逗他；班长另有独立同期声在旁边交代下车安排，本录音只演刘、何四句，不替班长加台词。刘文财较细干嗓，何有田粗嗓门，声音明显不同。第一轮两人自然接话，最后两句压低声音嘀咕，何有田最后的‘点’突然收断，像被外面的枪声打断，不补字，不长拖尾。完整连续表演，不插长空白。"}),
  Cue("TrainBriefing", [
