...
export const MISSION_DIALOGUE = Object.freeze([
  ...
  Cue("RoomAmbush", [
    ...
    ["zhou", "啊！肚子……狗日的……"],
    ["yaowa", "周哥！周哥！！"],
  ], { soundscape:"土墙灶屋里近身刺刀撞枪身的金属闷响、木担架砸到土地面、衣料撕扯、鞋底刮土地面、短促喘息和近处闷枪声；屋外远处交火压低，不盖住对白。", delivery:"幺娃第一句是撞见人影的惊叫、带破音；担架员短促急吼；老周被刺刀捅进肚子后气一下泄掉，断续吃痛；幺娃最后连喊两声撕心。四句一次连着演完，除稿中文字外不添加喊叫、惨叫或其他台词。" }),
  Cue("RoomAmbushBreak", [
    ["luo", "顺子！屋头咋个了！"],
    ["heyoutian", "屋头有鬼子！班长，进不进？"],
    ["luo", "进！上刺刀！看准了打，里头有自己人！"],
  ], { soundscape:"屋外院坝跑动脚步、刺刀扣上枪口的金属声、装备衣料碰撞，屋里的闷响和挣扎隔着土墙传出；远处机枪与零星步枪保持在对白下方。", delivery:"罗班长隔着土墙在屋外吼问，何有田贴到门边急问一句，班长立刻下决断、不犹豫；三句连着接话不留空档，压着火不慌乱。" }),
  Cue("RoomAmbushCleared", [
    ["yaowa", "周哥……周哥你莫闭眼，看到我！"],
    ["zhou", "肚子……遭捅穿了……"],
    ["liuwencai", "两个抬担架的……都没得了。"],
    ["luo", "文财！布！把他肚子压住！后头喊两个人上来抬！顺子——窗口那挺机枪还在响，去！"],
  ], { soundscape:"刚打完的土墙灶屋里急促呼吸、撕布、担架木杆和鞋底刮土地面、血湿的闷响；窗口那挺机枪仍在连续点射，屋外远处交火压低。", delivery:"幺娃带哭腔但不嚎啕，压着嗓子喊人；老周气弱只吐得出断句；刘文财压低声音报死讯；罗班长四道命令一句急过一句，末尾那个单字命令要吼出来。除稿中文字外不添加喊叫或其他台词。" }),
  Cue("CourtyardOpen", [
    ["luo", "通了！担架先过！"],
    ["bearer", "前头往里走！莫停门口！"],
  ]),
