...
export const MISSION_DIALOGUE = Object.freeze([
  ...
  Cue("BunkerBanter", [
    ...
    delivery: "四个人挤在小掩蔽部里，日常拌嘴、不慌，声音贴得很近。第五句是罗班长在门外隔着土墙喊进来，位置明显更远。末句「来了！顺哥，你那个——」说到「你那个」时被一声近距离爆炸硬生生切断：破折号后不许补字、不许收尾、不留余音，整条录音在这一下立刻结束，后面不要任何台词或长空白。",
  }),
  Cue("BunkerKilling", [
    ["ijaA", "站起来！快点！", { lang: "ja" }],
  ...
  Cue("MeleeCurse", [
    ...
    delivery: "白刃顶住对方时从胸腔里挤出来的一句，破音、带用力的憋气，不是骂人是发狠。不要惨叫。",
  }),
  Cue("WindowOrder", [
    ["luo", "我看这头！顺子，连屋那个窗口！"],
  ], {
  ...
  Cue("CourtyardOpen", [
    ...
    delivery: "罗班长在院门里头喊；幺娃在院墙外面，声音要明显隔着一堵墙、更远更薄，是把话往后头传。",
  }),
  Cue("TwoLitters", [
    ["liuwencai", "后头还有两副！"],
  ], {
  ...
  Cue("AircraftFirst", [
    ...
    delivery: "第一声是远处人群里炸开的示警，拖长、破音、能传很远；赶车人紧接着吼牲口，带农人吆喝的腔；罗班长是从后方赶过来的，声音由远及近，命令压过混乱。三句一句压一句，不留空档。",
  }),
  Cue("WestDitchOrder", [
  ...
  Cue("ZhouDeath", [
    ...
    delivery: "屋里几个人，语速整体是慢的，没有一个人在演悲痛。**第一句之后留约三秒空当**，这段空当里只有院外的搬运声和很远的枪声，没有任何台词——那是等回应没等到。幺娃第二句叫名字时声音已经变了；军医只是让路，例行；顺子刚把枪重新拿稳，那声「老周？」是半信半疑地确认；军医那句前面顿一下再说，平、低，不加重音；幺娃第六句是想把事实推回去，声音发飘；军医最后一句是重复，更短更硬，不带同情。结尾不要叹息、不要哭腔收尾。",
  }),
  Cue("NextLitter", [
    ["receiver", "这里还有一副！"],
    ["surgeon", "抬这边来。"],
