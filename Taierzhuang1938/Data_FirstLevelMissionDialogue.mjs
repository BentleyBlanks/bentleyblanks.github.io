...
export const MISSION_DIALOGUE = Object.freeze([
  ...
  Cue("TrainBanter", [
    ["liuwencai", "你莫伸手！老子刚数清楚，又遭你弄乱了。"],
    ["heyoutian", "几颗子弹，你数一路了，还能数出个崽儿嗦？"],
    ["liuwencai", "那你把手拿开嘛。"],
    ["heyoutian", "哪个稀罕你那点——"],
  // Background banter under Luo's simultaneous briefing: subtitle it as an aside.
  ], {subtitleEmphasis:"aside", delivery:"两名四川男兵站在车厢墙边，刘文财低头清点子弹，何有田随口逗他；班长另有独立同期声在旁边交代下车安排，本录音只演刘、何四句，不替班长加台词。刘文财较细干嗓，何有田粗嗓门，声音明显不同。第一轮两人自然接话，最后两句压低声音嘀咕，何有田最后的‘点’突然收断，像被外面的枪声打断，不补字，不长拖尾。完整连续表演，不插长空白。"}),
  Cue("TrainBriefing", [
    ["luo", "都听到！下车先跟到我，往沟里走。文财，把弹药带齐；何有田，你照应后头，莫落人。"],
  ], {delivery:"四川罗班长在车厢过道交代下车安排，低沉沙哑、抬声招呼全班，日常但有威信。旁边另有独立同期声在拌嘴，本录音只演班长的整段命令，不能替旁人加词。自然稍快、短促清楚，完整连续说完，不长停顿。"}),
  Cue("TrainShelling", [
    ["luo", "蹲下！脑壳收回来！"],
    ["yaowa", "打过来了！班长，打过来了！"],
    ["luo", "晓得！都莫慌，伏低！枪抓到，听我喊，莫自家往外头蹿！等这阵过去——"],
    ["soldier", "啊！手！手遭打中了！"],
    ["liuwencai", "忍到！手拿开，我给你包！"],
    ["luo", "顺子……顺子！"],
    ["luo", "看我。手拿来。"],
    ["luo", "抓紧……起！脚踩实！"],
    ["luo", "站得住不？……好，跟到我！"],
    ["luo", "侧翼让鬼子钻进来了！莫跑空地！贴车帮，借土埂进沟！"],
    ["heyoutian", "沟口也有鬼子！右边那条岔沟进来的！"],
    ["luo", "拿枪！清掉拐角那几个，进后头遮住的地方！"],
  ], {delivery:"完整连续多人四川话战场表演，罗班长低沉沙哑、幺娃清亮慌张、伤兵痛喊、文财较细干嗓。开头密集枪弹忽然打过来，班长猛吼‘蹲下’，全体伏低，幺娃惊慌重复。班长蹲低安抚，‘等这阵过去’突然截断，不能拖成感叹或补词。随后炮弹在车厢旁砸中，伤兵和文财急救。班长自己摔倒后第一次未站稳，喘息着喊顺子，第一声发哑，第二声才喊响；‘看我，手拿来’近距离说，‘抓紧，起’用力拉人时喘气，‘脚踩实’扶稳，最后确认能站住才带走。后面下沟命令恢复紧迫。不要念动作说明，不添加爆炸或环境音，不加台词，不插长空白，所有台词均须完整说出。"}),
  Cue("EscapeWhisper", [
    ["yaowa", "你包里那身百姓衣裳，还在？"],
    ["shunzi", "在。等喊送伤兵，老子就抢着去。到了后头，换上衣裳，混进老百姓里跑。"],
    ["yaowa", "你就不回队伍了？"],
    ["shunzi", "不回。老子不想死在这儿。"],
  ], {delivery:"炮击后惊魂未定的低声私语，压着喘息，贴近说话，不能恢复成车厢打趣；罗班长在不远处清点人。意思清楚，不省略逃跑计划。"}),
  Cue("SupportOrder", [
