...
export const MISSION_VOICE_CAST = Object.freeze({
  ...
  trainRear: ["后排士兵", "二十多岁四川男兵，略带鼻音，坐在后排，随口招呼同伴，声音稍远但听得清"],
  trainWindow: ["靠窗士兵", "三十岁左右四川男兵，中低嗓带气声，坐在另一侧窗边，慢半拍接话，和班长的沙哑嗓音区分"],
...
export const MISSION_DIALOGUE = Object.freeze([
  Cue("TrainMeal", [
    ...
    ["trainRear", "前头的，水壶递一下。"],
    ["trainWindow", "接到。给我留一口啊。"],
    ["heyoutian", "给老子也来一片。"],
    ["yaowa", "吃个锤子，昨晚上你就偷了两坨！"],
    ["heyoutian", "老子那叫尝咸淡。"],
    ["trainRear", "尝出啥子了？我们后头还没闻到味。"],
    ["shunzi", "听到没得？往后传嘛。"],
    ["yaowa", "手伸过来，莫掉地上。"],
    ["trainRear", "接到了。老李，掰一半。"],
    ["liuwencai", "十九……妈卖批，明明二十颗。"],
    ["heyoutian", "又少一颗？你数一晚上了。"],
    ["trainWindow", "脚抬下。是不是滚凳子底下了？"],
    ["liuwencai", "莫踩！……这儿。"],
    ["yaowa", "你看，冤枉哪个了嘛。"],
    ["trainWindow", "哎，外头那个闷响，你们听到没得？"],
    ["heyoutian", "车轮过岔道吧。"],
    ["trainRear", "不像哦，刚才就响过一回。"],
    ["yaowa", "班长，前头在打嗦？"],
    ["luo", "还没来信。坐稳，莫把脑壳往外伸。"],
    ["trainWindow", "雾蒙蒙的，啥子都看不清。"],
    ["shunzi", "你挤到我枪了，往里收点。"],
    ["trainRear", "哦。水壶还你，还剩点。"],
    ["yaowa", "顺哥，这片你还要不要？"],
    ["shunzi", "要。……莫全分了，你自己留点。"],
    ["luo", "吃完把家什收好，过道留出来。"],
    ["heyoutian", "晓得。文财，袋口扎紧，莫又滚了。"],
    ["liuwencai", "扎到的。你脚让一下。"],
  ], { delivery: "军列行进中吃东西的生活群戏，尚未遭袭，谁都不知道下一刻会发生什么。不要演成战场喊口号或轮流朗诵。顺子和幺娃近处递腊肉；后排与靠窗士兵先自行讨水、留水，听见前排分肉才插话，后来帮文财找子弹。七个声线始终分明，隔着座位接话，有随口搭腔、含着食物的短答、轻笑和自然呼吸，反应承接上一人说的事。短接话可紧跟上一句尾音，但可辨的台词不得互相盖住。听见远处闷响后笑声收住，短暂侧耳，猜测、追问都没把握；班长也不预知炮击，只让大家坐好。接着各自继续递水、收脚、吃肉，语气稍轻，不突然全员恐慌。整段一气呵成，停顿由演员自然完成，不分幕、不加长空白；只录这些人声，列车和远炮由游戏另外播放。" }),
  Cue("TrainShelling", [
    ["soldier", "炮——！冲咱们来的！"],
    ["luo", "伏低！司机，停车！"],
    ["soldier", "啊！手遭打中了！"],
