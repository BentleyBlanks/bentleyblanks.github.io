...
export const VOICE_LINES = [
  ...
  { key: "prologue_motivation_01", kind: "prologue", file: "AudioSfx_PrologueVoiceMotivation_02.mp3", dur: 21.70, role: "班长与众人", pitch: -2, prologue: true, backend: "seedaudio1.0", provider: "volcengine", promptMode: "continuousScene", lineCount: 8, text: "班长：这次你们去啊。晓不晓得，我们出来是做啥子？\n众人（先后，低声）：我们晓得。打日本。\n班长：去死，怕不怕？\n众人（齐声，低沉）：不怕。\n班长：为啥子不怕？\n众人（齐声，更沉）：我们要保护我们的国家。\n班长（哽咽了一下，点点头）：好样的。\n班长（收住哽咽，重新提起全车气势，以坚决的出发命令口吻）：都把东西带好。前头就是滕县。" },
