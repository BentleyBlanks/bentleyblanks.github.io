...
export const VOICE_LINES = [
  ...
  { key: "prologue_motivation_01", kind: "prologue", file: "AudioSfx_PrologueVoiceMotivation_03.mp3", dur: 21.75, role: "班长与众人", pitch: -2, prologue: true, backend: "seedaudio1.0", provider: "volcengine", promptMode: "continuousScene", lineCount: 8, text: "班长（洪亮、逐句升温）：这次你们去啊。晓不晓得，我们出来是做啥子？\n众人（十来人前后错开、坚定高喊）：我们晓得。打日本！\n班长（短促有力）：去死，怕不怕？\n众人（几人先起、其余瞬间压上）：不怕！\n班长（继续逼问）：为啥子不怕？\n众人（自然重叠、满腔热血）：我们要保护我们的国家！\n班长（哽咽一瞬）：好样的。\n班长（洪亮坚决地命令）：都把东西带好。前头就是滕县。" },
