...
const MATERIAL_MAP = {
  ...
  BuildingDamageEarly: { recipe: "BuildingDamageEarly", color: 0xf7f5f0, roughness: 1.0, normalScale: 0.94 },
  BuildingDamageSevere: { recipe: "BuildingDamageSevere", color: 0xf1ede5, roughness: 1.0, normalScale: 1.18 },
