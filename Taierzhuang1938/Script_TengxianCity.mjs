...
const MATERIAL_MAP = {
  ...
  BuildingDamageEarly: { recipe: "BuildingDamageEarly", color: 0xe8ecf2, roughness: 1.0, normalScale: 0.88 },
  BuildingDamageSevere: { recipe: "BuildingDamageSevere", color: 0xe8ecf2, roughness: 1.0, normalScale: 1.0 },
