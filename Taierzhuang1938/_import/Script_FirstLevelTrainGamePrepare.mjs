...
const source=path.join(root,'Models/FirstLevelTrainSupportV2'),out=path.join(root,'Models/FirstLevelTrainGameV1');
...
const manifest={version:'FirstLevelTrainGameV1',status:'runtime_seated_support_and_rise_subset',
 ...
 approachSeconds:.4,releaseSeconds:.8,riseStaggerSeconds:.35,floorClearanceM:.002,
