...
/**
 * 几个人同时说话时字幕的主次。主讲（交代任务的那句）排最下、字大、全亮；
 * 旁白（数据里 subtitleEmphasis:"aside" 的拌嘴、嘀咕）排上面、字小、压暗。
 * 远近另算一档：说话人离玩家眼睛超过 farM 米，这一行再压暗，
 * 不然车厢另一头的人和贴着耳朵说话的人读起来一样响。
 */
export const SUBTITLE_DEPTH = Object.freeze({
  /** 超过这个距离（米）的说话人算「远处」。车厢长约 10 m，班长在过道中段喊话不算远。 */
  farM: 7,
});
