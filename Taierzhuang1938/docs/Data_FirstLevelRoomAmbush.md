...
> **【已作废 · 2026-09-19】** 这一拍随第一关重构下线。
> 新稿（`docs/Data_FirstLevelRebuild20260919Contract.md` §2 / §4）里 09 改成：日军从与东巷相通的
> 连屋进来，**担架不进屋**、老周不在这里挨刀、没有担架员阵亡；玩家先手打掉就不触发固定僵持，
> 敌人真的贴上来才走共用白刃（`Script_MeleeCombat`）。运行时那七百行副作用与
