...
| 守军刮沟 `GuardBackslope` | (−27.2,−156.4)→(4.5,−156.2)，深 0.55 | 土坎南坡脚，北面被土坎挡死、南面（射台）看得见；西头 `ScrapeWestTraverse` 土横墙封住，守军只能走缺口；东头外 `ScrapeEastTraverse` (5.9,−156.9) 挡住侧翼组末线顺沟的视线 |
...
| 唯一缺口 `gap` | (−8,−150)，缺口支沟 `GuardWithdrawal` 在此塌浅到 0.5 m | 背坡铁丝网 `BackslopeWire0–5` 堵死缺口以东，放在缺口点以南 1 m（z −149，东两卷 −149.6 让开右低沟北沿的射击湾）：运行时要看缺口的线（机枪座、夺下的枪、西门、战车在 Block/Squeeze 的炮口）都在它北边汇到缺口，铁丝网的桩和线是射线碰撞体，放在北边会切断其中一条 |
