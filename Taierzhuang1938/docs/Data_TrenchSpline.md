...
**2026-09-26 外观更新**：通用壕沟按[概念图 07 裸土风格](Data_TrenchReference07.md)执行。默认不再布设木护壁与踏板，改为碎土沟沿、嵌石与细根；下文护壁参数和 2026-09-17 数量是旧式显式 `timber: true` 模式的历史说明。开挖、通行和共享高度场契约不变。
