...
> “播放序章”按钮，用该真人手势解锁 WebAudio；点击后 95 秒流程不再等待任何交互。
...
| 镜 | 秒 | 画面 | 字幕/台词 |
|---|---|---|---|
| 1 | 5 | 黑场字卡（titleCard，fadeIn） | 「一九三七年十二月，南京陷落。」「日军南北对进，要打通津浦铁路，会师徐州。」（主流） |
| 2 | 5 | 黑场字卡 | 「一九三八年三月，北路日军第十师团濑谷支队沿津浦路南下。」「滕县，是徐州以北津浦正面的最后一道屏障。」（主流） |
| 3 | 6 | 实景：拂晓原野土路，低机位，一队川军的脚与绑腿走过（从黑淡入） | 「守滕县的是川军第二十二集团军。一九三七年九月出川，徒步一千四百余公里北上抗日。」（主流） |
| 4 | 6 | 实景：侧移轨，行军纵队侧影（布军帽、无钢盔，三人里一人空手） | 「十月，娘子关，一周损失过半。此后无人补充，几经转调，一九三八年初划归第五战区，开赴鲁南。」（主流） |
| 5 | 6 | 实景：队伍背影朝雾里的滕县城墙走（城墙在 100—150 m 外当剪影） | 「第四十一军第一二二师师长王铭章，奉命守滕县城。」「城内能战之兵不足两千，无钢盔，三分之一以上没有步枪。」（主流） |
| 6 | 6 | 实景：近一点，一个年轻兵（玩家，背影/侧影）与身旁的班长 | 字幕「你是第七二七团三营九连二等兵谢长顺，四川三台人，十八岁。」；台词 班长：「长顺，跟紧了。进了城就有饭。」（虚构） |
| 7 | 4 | 黑场字卡 | 「三月十四日 拂晓 · 界河」（date 样式） |

- 实景建议直接在 L0 场的城北/城东原野拍（standalone:false），天空用本关的 dawn（不给 sky 字段）或 `sky:"dawn"`。人要贴地（y≈−1.2，出图校）。
- 行军纵队 8—11 人，每三人里一人 weapon:null；moveSpeed 0.30 ↔ 1.26 m/s。
- skipCard 把 1/2/3/4/5/6 的事实句全列上。
- forbiddenLines 照旧：「抗日无力，扰民有余」「土匪部队」「诸葛亮还扎草人当疑兵」。
