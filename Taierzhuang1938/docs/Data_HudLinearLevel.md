...
| 目标路标 | 旧切片用 `.hudMarker`；正片第一关用唯一的 `.hudMissionGuide`：跟随时绿色空心菱形钉在真实班长上，操作 / 战斗时转到淡金色实际目标，屏外贴边指向，近处收起距离 | COD WWII / WaW 单人战役约定；2026-09-14 用户要求取代此前第一关不画跟随标记的决定，见[罗班长引导](Data_FirstLevelLeaderGuide.md) |
