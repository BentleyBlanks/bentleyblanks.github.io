...
- **现状**：Space 先调用 TryVault；没有可翻物时才 TryJump。起跳速度 4.65 m/s、重力 19.6 m/s²，净抬高约 0.55 m；卧姿/涉水/体力不足不响应，起跳消耗 0.08 体力，落地有 0.16 s 重心恢复。视图模型与第三人称骨架都有上升、下落、落地姿态，半空散布 ×2.4。
- **保持**：不提高跳高、不开放连跳加速；它只解决沟坎、瓦砾与低矮卡点，院墙仍走翻越动作
