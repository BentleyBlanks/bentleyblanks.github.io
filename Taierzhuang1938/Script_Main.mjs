...
async function Boot() {
  ...
  const PBR_SETS = [
    ...
    { name: "Type89Armor",
      albedo: "./Texture/Texture_Type89ArmorBase.webp?v=type89-20260906",
      normal: "./Texture/Texture_Type89ArmorNormal.webp?v=type89-20260906",
      orm: "./Texture/Texture_Type89Orm.png?v=type89-20260906" },
    { name: "Type89Track",
      albedo: "./Texture/Texture_Type89TrackBase.webp?v=type89-20260906",
      normal: "./Texture/Texture_Type89TrackNormal.webp?v=type89-20260906",
      orm: "./Texture/Texture_Type89Orm.png?v=type89-20260906" },
    { name: "GrenadePbr",
      albedo: "./Texture/Texture_GrenadeBase.webp?v=grenade20260906",
      normal: "./Texture/Texture_GrenadeNormal.webp?v=grenade20260906",
      orm: "./Texture/Texture_GrenadeOrm.webp?v=grenade20260906" },
    { name: "DadaoPbr",
    ...
    { name: "CraterScorched",
      albedo: "./Texture/Texture_CraterScorchedBase.webp?v=2",
      normal: "./Texture/Texture_CraterScorchedNormal.webp?v=2",
      orm: "./Texture/Texture_CraterScorchedOrm.webp?v=2" },
    { name: "Ground",
      albedo: "./Texture/Texture_MissionSoilBase.webp?v=1",
      normal: "./Texture/Texture_MissionSoilNormal.webp?v=1",
      orm: "./Texture/Texture_MissionSoilOrm.png?v=1" },
  ...
  // 的真事件链 —— 测的是键位与玩法，不是函数。
  window.Taierzhuang.Debug.TerrainDeformation = {
    State: () => battlefield.deformation?.State(),
    Height: (x, z) => battlefield.GroundHeight(x, z),
    BaseHeight: (x, z) => battlefield.BaseGroundHeight(x, z),
    Reset: () => battlefield.deformation?.Reset(),
  };
  window.Taierzhuang.Debug.Explosions = {
...
async function BuildField(phase, setStep, base, span, yieldFrame = NextFrame) {
  ...
  await battlefield.LoadVehicles?.();
...
function BuildPhysics() {
  ...
  battlefield.deformation?.AttachPhysics(physics);
