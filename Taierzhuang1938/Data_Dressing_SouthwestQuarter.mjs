...
export const PLACEMENTS = Object.freeze([
  ...
  { asset: "marketCrate02", x: -41.08, z: 16.01, ry: 0.22,
    note: "十字街西南角铺户后院：西墙根码起来的板条箱，掌柜把存货从铺面挪进后院" },
  { asset: "marketCrate04", x: -41.63, z: 16.08, ry: -0.35, scale: 0.95,
    note: "同一户：紧挨着的另一只板条箱，先搬进来的那一批" },
  { asset: "marketBox02", x: -40.39, z: 16.16, ry: 0.48, scale: 0.9,
    note: "同一户：还没捆绳的一只木箱，搁在库房与后院门之间的过道边" },

  // ── blk8_13（一进院）：麦子收进院 ──
  { asset: "marketRiceSack01", x: -60.57, z: 18.33, ry: 0.31,
    note: "十字街西南的一进院：影壁西侧靠院墙码的粮袋，围城第三天把存粮全搬进了院" },
  { asset: "marketRiceSack02", x: -61.11, z: 18.17, ry: -0.52, scale: 0.95,
    note: "同一户：第二只粮袋，口朝里立着防潮" },
  { asset: "marketBox01", x: -60.07, z: 17.69, ry: 0.17,
    note: "同一户：粮袋边上一只小木箱，装的是零碎细软" },

  // ── blk7_13（L 形院）：车擦干净备着 ──
  { asset: "cart", x: -79.59, z: 18.07, ry: 0.62, scale: 0.95,
    note: "L 形院西厢房南头空当：手推车拉到院里备着，出城的路一开就走" },
  { asset: "marketBox03", x: -77.67, z: 18.93, ry: -0.24, scale: 0.9,
    note: "同一户：捆好搁在车旁的大箱笼" },
  { asset: "marketCrate01", x: -77.38, z: 17.58, ry: 0.41,
    note: "同一户：一只板条箱，装的是能拎得动的那点家当" },

  // ── blk5_13（土墙院）：矮墙南边的柴院 ──
  { asset: "deadTreeTrunk01", x: -133.21, z: 18.71, ry: 0.28, scale: 0.9,
    note: "土墙院后院柴院：劈剩的一根枯树干，去年冬天砍的那棵老槐" },
  { asset: "stackableStone02", x: -131.8, z: 18.3, ry: -0.66,
    note: "同一户：垫柴用的一块过墙石，从塌了的墙脚拆下来的" },

  // ── blk4_13（两进院）：前院箱笼捆好 ──
  { asset: "marketBox03", x: -162.53, z: 18.92, ry: 0.09,
    note: "西门大街南侧两进院前院：二门与倒座之间，箱笼捆好等雇脚夫" },
  { asset: "marketCrate03", x: -161.82, z: 18.45, ry: -0.31, scale: 0.95,
    note: "同一户：前院第二只箱子，绳还没系上" },
  { asset: "marketCrate04", x: -162.84, z: 18.21, ry: 0.55, scale: 0.9,
    note: "同一户：贴西院墙那一只，挪出过道好让车进来" },

  // ── blk3_13（窄一进院）：家底薄的一户 ──
  { asset: "crate", x: -207.56, z: 18.84, ry: 0.37, scale: 0.95,
    note: "顺兴街西的窄院：厢房山墙下一只木箱，这户全部的行装" },
  { asset: "stackableStone03", x: -206.56, z: 19.54, ry: -0.78,
    note: "同一户：门道边的垫脚石，下雨天踩着进屋" },

  // ── blk2_13（L 形院，几乎没挨炸）：收拾得齐整 ──
  { asset: "marketRiceSack01", x: -217.18, z: 18.46, ry: 0.12,
    note: "西门大街南侧齐整人家：东厢房墙根码齐的两只粮袋，摆得四四方方" },
  { asset: "marketRiceSack02", x: -217.38, z: 19.4, ry: -0.18, scale: 0.95,
  ...
  // ── blk2_15（两进院）：前院也在打包 ──
  { asset: "marketBox02", x: -233.55, z: 66.72, ry: 0.26,
    note: "城西两进院前院：倒座房北面的木箱，装了一冬的被褥" },
  { asset: "marketCrate01", x: -232.75, z: 66.02, ry: -0.44, scale: 0.95,
    note: "同一户：箱子旁的板条箱，装的是锅碗" },

  // ── blk5_15（水井院）：几户共用的井台 ──
  { asset: "marketRiceSack02", x: -137.88, z: 67.25, ry: 0.33,
    note: "水井院西墙根：从井台让开的一只粮袋，打水的路不能堵" },
  { asset: "stackableStone07", x: -138.66, z: 68.12, ry: -0.61, scale: 0.9,
    note: "同一户：搬来垫粮袋的一块石头，还没垫上" },

  // ── blk6_17（人民书店后邻，读书人家） ──
  { asset: "marketCrate02", x: -96.23, z: 120.28, ry: 0.15,
    note: "人民书店后邻的读书人家：西院墙根第一只书箱，捆得最结实" },
  { asset: "marketBox01", x: -95.53, z: 121.28, ry: -0.27,
    note: "同一户：书箱旁的小木箱，装的是笔墨与几本旧书" },
  { asset: "marketBox02", x: -95.93, z: 122.28, ry: 0.39, scale: 0.95,
    note: "同一户：第三只，绳还没来得及捆上" },

  // ── blk0_18（西南水井院）──
  // 摆在井台北边而不是南边：z 再往南就出了 L5 的切片（maxZ=140），
  // 那两块石头就只在 L6 的中景档里付 draw call，玩家一辈子走不到跟前。
  { asset: "stackableStone03", x: -255.17, z: 143.42, ry: 0.52, scale: 1.1,
    note: "城西南水井院东墙根：拆下来待用的过墙石，井台那圈条石缺了两块" },
  { asset: "stackableStone04", x: -254.47, z: 144.12, ry: -0.36,
    note: "同一户：同一堆里另一块小的" },

  // ── blk9_18（土墙院）：车装了半车 ──
  // 同上：这一户的柴院整条都在 z>140，车摆过去等于摆在 L5 视野之外，
  // 挪到矮墙以北的前院东侧 —— 车本来也该停在能出院门的那一头。
  { asset: "cart", x: -8.09, z: 143.44, ry: -0.48, scale: 0.92,
    note: "城南中段土墙院前院：手推车已经装了半车，车辕朝着院门那一头" },
  { asset: "crate", x: -10.29, z: 144.54, ry: 0.29, scale: 0.95,
    note: "同一户：还没搬上车的一只木箱，撂在车后半步" },

  // ── blk10_20（L 形院，挨了流弹）：南面开始乱 ──
  { asset: "rubble", x: -28.09, z: 198.6, ry: 0.34,
    note: "十字街正南、离迎薰门还有百来米的一户：一发流弹打塌了西院墙一段，砖瓦塌在菜畦南头" },
  { asset: "stackableStone07", x: -27.29, z: 200.5, ry: -0.55, scale: 0.9,
    note: "同一户：从塌处滚出来的一块碱脚石，没人顾得上收" },

  // ── blk9_22（L 形院）：靠南也在收粮 ──
  { asset: "marketRiceSack01", x: -62.24, z: 229.15, ry: 0.21,
    note: "南城书院一带的院子：粮袋搬进院心西侧，离南墙远一点——南面的动静最响" },
  { asset: "marketBox01", x: -61.34, z: 229.95, ry: -0.39, scale: 0.95,
    note: "同一户：粮袋旁一只木箱，装着换洗衣裳" },

  // ── blk8_24（烧过的土墙院）：城南根 ──
  { asset: "rubble", x: -153.88, z: 281.8, ry: -0.22, scale: 1.05,
  ...
  { asset: "clayWaterVat", x: -114.41, z: 17.07, ry: 0.12,
    note: "西门大街南侧一进院：西厢山墙下的水缸，围城以来一天挑满三回" },
  { asset: "phWoodenBucket", x: -114.54, z: 17.67, ry: -0.38,
    note: "同一户：缸边撂着的木桶，桶绳还搭在桶沿上" },
  { asset: "wovenBasket", x: -114.46, z: 18.22, ry: 0.44, scale: 0.95,
    note: "同一户：翻过来扣着的笸箩，晾过的菜干早收进屋了" },

  // ── blk0_14（OneEntry）：西城根：柴劈到一半 ──
  { asset: "firewoodPile", x: -279.02, z: 34.72, ry: 0.08,
    note: "西城根土院：西墙根码起来的柴垛，够烧到清明" },
  { asset: "ryChoppingBlock", x: -279.36, z: 35.8, ry: -0.26,
    note: "同一户：柴垛头上的劈柴墩，斧印新的" },
  { asset: "phWoodAxe", x: -279.36, z: 36.54, ry: 0.85, scale: 1.05,
    note: "同一户：斧子撂在墩子边上——劈到一半，城头响了" },

  // ── blk1_14（OneEntry）：王家祠堂东邻：晾晒架空着 ──
  { asset: "ryDryingRack", x: -269.34, z: 62.21, ry: 0.05,
    note: "王家祠堂东邻：院里的晾晒木架，被褥昨天就收进屋了，架子空着" },
  { asset: "winnowingBasket", x: -268.65, z: 62.13, ry: 1.51,
    note: "同一户：簸箕靠着架子腿立着，簸完的那点麦子已经装了袋" },

  // ── blk2_14（LCourtyard）：酱园户：一溜缸坛 ──
  { asset: "clayWaterVat", x: -231.1, z: 36.06, ry: 0.06,
    note: "城西酱园户：西院墙根一溜四口缸坛，头一口是水缸" },
  { asset: "clayRoundVat", x: -231.07, z: 36.85, ry: -0.14,
    note: "同一户：第二口圆腹缸，去年秋天下的黄豆酱" },
  { asset: "clayLiddedJar", x: -231.13, z: 37.59, ry: 0.21,
    note: "同一户：有盖的咸菜坛，盖上压着一块河石" },
  { asset: "clayWideJar", x: -231.11, z: 38.31, ry: -0.3, scale: 0.95,
    note: "同一户：末一口阔口坛，空的——腌菜的盐买不着了" },

  // ── blk3_14（AdobeYard）：顺兴街西小磨房 ──
  { asset: "stoneMillWheel", x: -193.25, z: 38.27, ry: 0.33,
    note: "顺兴街西的小磨房院：卸下来的石磨盘平放在东墙根，磨道上的驴前天被拉走了" },
  { asset: "winnowingBasket", x: -193.04, z: 39.44, ry: 1.67,
    note: "同一户：磨盘旁靠墙立着的簸箕，箩底还挂着一层面" },

  // ── blk4_14（OneEntry）：西门大街南侧修车的人家 ──
  { asset: "ryCartWheel", x: -177.74, z: 37.14, ry: 0.1,
    note: "西门大街南侧修车的人家：靠墙立着的一只大车轮，辐条换了两根还没上箍" },
  { asset: "ryTimberStack", x: -177.65, z: 37.85, ry: -0.22,
    note: "同一户：车轮旁的木料堆，本来是给邻家打棺材的料" },
  { asset: "phIronSpade", x: -177.73, z: 38.58, ry: 0.66,
    note: "同一户：铁锹撂在料堆边——挖防空壕的人家一天来借三回" },

  // ── blk5_14（TwoEntry）：两进院：细软捆好了 ──
  { asset: "marketBox02", x: -134.26, z: 35.78, ry: 0.17,
    note: "城西两进院：前院墙根的木箱，捆好了，绳头留着好拎" },
  { asset: "phWickerBasketLidded", x: -134.33, z: 36.2, ry: -0.41,
    note: "同一户：箱上没地方了，带盖的竹篮只好搁在旁边地上" },

  // ── blk0_15（OneEntry）：城西水井院：打水的家伙什 ──
  { asset: "phWoodenBucket", x: -206.99, z: 85.58, ry: 0.28,
    note: "城西水井院：让开井台码在西墙根的木桶，一条巷子共用一口井，路不能堵" },
  { asset: "phWoodenWashTub", x: -206.88, z: 86.09, ry: -0.19,
    note: "同一户：木盆扣在桶边，昨天洗的衣裳还挂在屋里" },

  // ── blk1_15（AdobeYard）：土墙院柴院：备下过冬的柴 ──
  { asset: "ryFirewoodStack", x: -243.88, z: 64.63, ry: 0.09,
    note: "城西土墙院的柴院：矮墙南边码齐的一垛硬柴" },
  { asset: "phFirewoodBranches", x: -243.86, z: 65.62, ry: -0.34,
    note: "同一户：柴垛旁散着的一抱柴枝，引火用的" },
  { asset: "ryChoppingBlock", x: -243.73, z: 66.47, ry: 0.52,
    note: "同一户：劈柴墩挪到了墙根——院心要留出来搁车" },

  // ── blk3_15（OneEntry）：顺兴街西窄院：桌凳搬到院里 ──
  { asset: "longBench", x: -196.24, z: 61.7, ry: 0.14,
    note: "顺兴街西的窄院：条凳挪到东墙根，屋里腾地方铺被褥——两家人挤在一处住" },
  { asset: "phChineseWoodStool", x: -195.88, z: 62.9, ry: -0.47,
    note: "同一户：条凳边一只方凳，凳面磨得发亮" },

  // ── blk4_15（AdobeYard）：土墙院：咸菜坛挪进后院 ──
  { asset: "clayLiddedJar", x: -158.55, z: 36.75, ry: 0.11,
    note: "城西土墙院：咸菜坛从窗台底下挪到西墙根，怕震塌了砸着" },
  { asset: "clayLuggedJar", x: -158.56, z: 37.3, ry: -0.29, scale: 0.95,
    note: "同一户：带耳的小罐搁在坛子边，装的是半罐香油" },

  // ── blk10_15（AdobeYard）：南门里酒栈后院 ──
  { asset: "wineJarCluster", x: -98.94, z: 173.64, ry: 0.19,
    note: "南门里大街西侧酒栈的后院：一堆酒坛挪到南墙根，掌柜说封了泥就不怕震" },
  { asset: "clayRoundVat", x: -97.74, z: 173.79, ry: -0.24, scale: 0.95,
    note: "同一户：空出来的一口圆腹缸，原先盛酒糟，现在接房檐水" },

  // ── blk0_16（OneEntry）：西城根土院：菜园家什 ──
  { asset: "ryFarmHoe", x: -279.07, z: 88.61, ry: 0.72,
    note: "西城根土院：锄头撂在西墙根，城根这几户还种着半亩菜" },
  { asset: "phIronSpade", x: -279.21, z: 89.7, ry: -0.55,
    note: "同一户：铁锹搁在锄头边上——这两天挖的是防空坑，不是菜畦" },

  // ── blk1_16（AdobeYard）：城根土院：牲口牵走了 ──
  { asset: "ryFeedTrough", x: -239.18, z: 85.59, ry: 0.08,
    note: "城西城根土院：空着的木食槽，那头骡子前天被军队牵走了，留了一张条子" },
  { asset: "ryHayStack", x: -239.11, z: 86.51, ry: -0.16,
    note: "同一户：没人吃的秸秆垛，照旧堆在槽子边" },
  { asset: "ryFarmHoe", x: -239.32, z: 87.55, ry: 0.61, scale: 0.95,
    note: "同一户：锄头横在垛脚，牲口一走，地也就撂下了" },

  // ── blk2_16（LCourtyard）：L 形院：菜畦边的凳子 ──
  { asset: "ryYardBench", x: -230.64, z: 90.38, ry: 0.12,
    note: "城西 L 形院：菜畦边的长条木凳，晌午一家人还在这儿吃饭" },
  { asset: "phClayFlowerPot", x: -231.15, z: 91.35, ry: -0.35,
    note: "同一户：凳头一只素陶瓦盆，里头的葱苗刚冒头" },

  // ── blk3_16（AdobeYard）：顺兴街西土墙院 ──
  { asset: "clayWaterVat", x: -168.89, z: 61.66, ry: 0.15,
    note: "顺兴街西的土墙院：东墙根的水缸满着——巷口的井这两天排队" },
  { asset: "winnowingBasket", x: -168.88, z: 62.38, ry: 1.45,
    note: "同一户：簸箕靠着缸立着，随手就能盖住缸口挡灰" },

  // ── blk7_16（OneEntry）：当典后街南的浅院 ──
  { asset: "phRoughWoodTable", x: -83.22, z: 145.86, ry: 0.1,
    note: "当典后街南的浅院：粗木桌搬到院里当案板用，屋里的窗户拿门板堵死了" },
  { asset: "phChineseWoodStool", x: -82.07, z: 146.18, ry: -0.44,
    note: "同一户：桌子边一只方凳，凳上撂着没缝完的鞋底" },

  // ── blk8_16（OneEntry）：城西南浅院：粮先搬进来 ──
  { asset: "marketRiceSack01", x: -120.33, z: 171.71, ry: 0.23,
    note: "城西南的浅院：一只粮袋倚着南院墙，先搬进来的那一袋" },
  { asset: "wovenBasket", x: -119.34, z: 171.82, ry: -0.37,
    note: "同一户：笸箩扣在袋子上，防猫也防灰" },

  // ── blk9_16（OneEntry）：挨了一发的浅院 ──
  { asset: "rubble", x: -58.27, z: 120.09, ry: 0.31, scale: 0.9,
    note: "十字街正南第一排的浅院：一发落在墙外，震塌了南墙一角，砖瓦就摊在原地" },
  { asset: "stackableStone02", x: -56.76, z: 120.71, ry: -0.62,
    note: "同一户：滚出来的一块碱脚石，人还在屋里，没人出来收" },

  // ── blk10_16（OneEntry）：南门里铺户：门板卸下来了 ──
  { asset: "shopPlaque", x: -162.79, z: 67.12, ry: 0.04,
    note: "南门里大街西侧铺户后院：卸下来的一块铺面门板靠在南院墙上，铺子昨天就上了板" },
  { asset: "crate", x: -161.79, z: 67.22, ry: -0.28, scale: 0.95,
    note: "同一户：门板边一只木箱，掌柜把柜上的零碎都倒进去了" },

  // ── blk0_17（OneEntry）：城西根一进院 ──
  { asset: "clayRoundVat", x: -283.63, z: 118.17, ry: 0.13,
    note: "城西根一进院：西墙根的圆腹缸，接了大半缸房檐水" },
  { asset: "bambooHat", x: -283.75, z: 118.93, ry: -0.4,
    note: "同一户：斗笠扣在缸沿边的地上，戴它的人一早去城头背土了" },

  // ── blk1_17（AdobeYard）：土墙院：石圈柴堆 ──
  { asset: "ryFirewoodPit", x: -230.59, z: 115.95, ry: 0.07,
    note: "城西土墙院：院里的石圈柴堆，一家人这几天都在院里生火做饭" },
  { asset: "phWoodAxe", x: -230.37, z: 117.21, ry: 0.94,
    note: "同一户：斧子搭在石圈边上，随手就够得着" },

  // ── blk2_17（LCourtyard）：一点没挨着的那户：桌凳灯都还在院里 ──
  { asset: "phRoughWoodTable", x: -222.22, z: 114.46, ry: 0.09,
    note: "城西一点没挨着的那户：粗木桌照旧摆在院里，饭还在这儿吃" },
  { asset: "longBench", x: -222.2, z: 115.67, ry: -0.18,
    note: "同一户：桌边的条凳，坐得下一家五口" },
  { asset: "phChineseWoodStool", x: -222.48, z: 116.63, ry: 0.36,
    note: "同一户：矮一头的方凳，是给最小的那个坐的" },
  { asset: "clothLantern", x: -222.56, z: 117.22, ry: -0.11,
    note: "同一户：布灯笼摘下来搁在凳上——夜里不许点灯了" },

  // ── blk3_17（AdobeYard）：顺兴街南口土墙院 ──
  { asset: "stoneMillWheel", x: -170.81, z: 116.47, ry: -0.28,
    note: "顺兴街南口的土墙院：磨盘撂在东墙根，上面压着一块苫布——碾完的麦子已经装了口袋" },
  { asset: "wovenBasket", x: -170.65, z: 117.11, ry: 0.47, scale: 0.95,
    note: "同一户：笸箩撂在磨盘边，箩里还剩一层麸皮" },

  // ── blk7_17（TwoEntry）：人民书店西南的两进院 ──
  { asset: "marketCrate03", x: -120.83, z: 195.12, ry: 0.16,
    note: "人民书店西南的两进院：西院墙根捆好的板条箱，箱盖上用炭写了字" },
  { asset: "phWickerTray", x: -120.93, z: 195.95, ry: -0.33,
    note: "同一户：竹编浅筐撂在箱上，里头是路上吃的干粮" },

  // ── blk8_17（OneEntry）：城南中段一进院：坛子搬进屋前 ──
  { asset: "clayLiddedJar", x: -161.07, z: 171.22, ry: 0.1,
    note: "城南中段一进院：两口咸菜坛挪到西墙根，等着一并搬进屋" },
  { asset: "clayWideJar", x: -161.04, z: 172.17, ry: -0.27, scale: 0.95,
    note: "同一户：阔口坛歪着搁，坛口那圈泥还没封上" },

  // ── blk9_17（LCourtyard）：十字街正南的 L 形院 ──
  { asset: "ryDryingRack", x: -19.85, z: 117.75, ry: 0.06,
    note: "十字街正南的 L 形院：晾晒架上什么也没有——衣裳前天夜里就摘光了" },
  { asset: "phWoodenWashTub", x: -19.3, z: 119.1, ry: -0.42,
    note: "同一户：木盆扣在架子下，盆底朝天" },

  // ── blk10_17（OneEntry）：南门里挨了流弹的一户 ──
  { asset: "rubble", x: -16.64, z: 67.03, ry: 0.36, scale: 0.95,
    note: "南门里大街西侧挨了流弹的一户：南墙塌了一段，砖瓦压着半畦菜" },
  { asset: "clayWideJar", x: -15.97, z: 67.3, ry: -0.71, scale: 0.9,
    note: "同一户：震翻在砖堆边的一口阔口坛，坛里的菜撒了一地" },

  // ── blk1_18（LCourtyard）：城西 L 形院：车推到了院里 ──
  { asset: "cart", x: -223.19, z: 148.16, ry: 0.55, scale: 0.94,
    note: "城西 L 形院：手推车推到东墙根，车辕朝着院门那一头" },
  { asset: "crate", x: -221.97, z: 147.35, ry: -0.31,
    note: "同一户：还没搬上车的一只木箱，撂在车后半步" },

  // ── blk2_18（AdobeYard）：土墙院：水缸挪到墙根 ──
  { asset: "clayWaterVat", x: -212.67, z: 143.05, ry: 0.14,
    note: "城西土墙院：水缸从院心挪到西墙根，院心要留出走车的道" },
  { asset: "phWoodenBucket", x: -212.83, z: 143.79, ry: -0.36,
    note: "同一户：木桶搁在缸边，绳子还系在桶梁上" },

  // ── blk3_18（TwoEntry）：顺兴街南口两进院：一冬的粮 ──
  { asset: "marketRiceSack01", x: -170.07, z: 143.2, ry: 0.19,
    note: "顺兴街南口的两进院：东院墙根码的两只粮袋，一冬的口粮全在这儿" },
  { asset: "marketRiceSack02", x: -170.06, z: 143.75, ry: -0.24, scale: 0.95,
    note: "同一户：第二只粮袋，口朝里立着防潮" },

  // ── blk7_18（LCourtyard）：人民书店西邻的读书人家 ──
  { asset: "marketCrate01", x: -109.92, z: 143.57, ry: 0.15,
    note: "人民书店西邻：西墙根一只板条箱，装的是从铺子里搬回来的书" },
  { asset: "phWoodLantern", x: -110.07, z: 144, ry: -0.39,
    note: "同一户：木框风灯挂不成了，摘下来搁在箱头上" },

  // ── blk8_18（OneEntry）：城南小酒坊 ──
  { asset: "wineJarCluster", x: -59.5, z: 144.06, ry: 0.22,
    note: "城南的小酒坊后院：封了泥的酒坛堆在墙根，掌柜说打完仗再启" },
  { asset: "clayLuggedJar", x: -59.73, z: 145.13, ry: -0.3, scale: 0.95,
    note: "同一户：带耳的小罐搁在坛堆边，装的是拿去换粮的那点酒" },

  // ── blk10_18（OneEntry）：南门里一进院：碾完了 ──
  { asset: "stoneMillWheel", x: -69.17, z: 179.42, ry: 0.24,
    note: "南门里大街西侧一进院：碾完的石磨盘平撂在院里，麦子昨天夜里就磨完了" },
  { asset: "winnowingBasket", x: -68, z: 179.63, ry: -0.08,
    note: "同一户：簸箕靠着磨盘立着" },

  // ── blk10_19（LCourtyard）：南城 L 形院：车装了一半 ──
  { asset: "cart", x: -35.07, z: 178.28, ry: -0.52, scale: 0.92,
    note: "南城 L 形院：手推车装了一半，车上是被褥与一口锅" },
  { asset: "bambooHat", x: -33.42, z: 179.15, ry: 0.33,
    note: "同一户：斗笠撂在车边地上，走的时候准得戴上" },

  // ── blk9_21（OneEntry）：挨了流弹的一进院 ──
  { asset: "rubble", x: -49.09, z: 198.99, ry: 0.29, scale: 0.95,
    note: "南城书院西北的一进院：一发流弹掀了半面山墙，砖瓦塌在院里" },
  { asset: "stackableStone07", x: -47.46, z: 199.6, ry: -0.58, scale: 0.9,
    note: "同一户：从塌处滚出来的一块碱脚石，压着半只烂笸箩" },

  // ── blk10_21（AdobeYard）：烧过的土墙院 ──
  { asset: "rubble", x: -37.43, z: 229.29, ry: -0.34,
    note: "南门里烧过的土墙院：烧塌的一段土坯连着焦瓦，火是前天夜里灭的" },
  { asset: "stackableStone03", x: -35.83, z: 230.03, ry: 0.67, scale: 1.05,
    note: "同一户：过墙石从碱脚里翻出来，黑了半边" },

  // ── blk10_22（OneEntry）：南城一进院：还没走的人家 ──
  { asset: "marketRiceSack02", x: -87.83, z: 203.02, ry: 0.2,
    note: "南城一进院：粮袋立在墙根——这一户还没打算走" },
  { asset: "phWickerBasketLidded", x: -87.03, z: 203.14, ry: -0.45,
    note: "同一户：带盖的竹篮压在粮袋上，篮里是几件换洗衣裳" },

  // ── blk8_23（AdobeYard）：书院小学东邻：柴还在劈 ──
  { asset: "firewoodPile", x: -59.16, z: 247.53, ry: 0.11,
    note: "书院小学东邻的土墙院：柴垛码在西墙根，学堂停课以后这一带静得出奇" },
  { asset: "ryChoppingBlock", x: -59.61, z: 248.93, ry: -0.29,
    note: "同一户：劈柴墩就在垛前，墩面上的斧印是今早的" },

  // ── blk9_23（WellYard）：南城水井院：井台让出来 ──
  { asset: "phWoodenBucket", x: -148.15, z: 249.53, ry: 0.26,
    note: "南城水井院：从井台让开的木桶，几户共用一口井，路不能堵" },
  { asset: "ryWaterBucket", x: -148.16, z: 249.9, ry: -0.41,
    note: "同一户：小水桶摞在大桶边上" },

  // ── blk10_23（LCourtyard）：烧空的 L 形院 ──
  { asset: "rubble", x: -27.11, z: 258.7, ry: 0.38, scale: 1.05,
    note: "南门里烧空的 L 形院：厢房塌了一半，砖瓦连着焦木堆在院心南头" },
  { asset: "stackableStone05", x: -25.42, z: 259.45, ry: -0.64,
    note: "同一户：一块过墙石从塌处滚到院当中，绊了路" },

  // ── blk9_24（WellYard）：城南根水井院 ──
  { asset: "clayWaterVat", x: -100.06, z: 275.62, ry: 0.16,
    note: "城南根的水井院：西墙根的水缸满着，井离得近，这一带不缺水" },
  { asset: "winnowingBasket", x: -100.08, z: 276.54, ry: 1.65,
    note: "同一户：簸箕靠着缸立着，簸的是最后一点谷子" },

  // ── blk10_24（LCourtyard）：城南根最乱的一角 ──
  { asset: "rubble", x: -36.01, z: 283.87, ry: -0.27, scale: 1.1,
    note: "城南根最乱的一角：南院墙塌了整段，砖瓦土坯摊了半个院子" },
  { asset: "deadTreeTrunk02", x: -33.1, z: 283.3, ry: 0.48, scale: 0.85,
    note: "同一户：院里那棵老槐被削断了，树干横在砖堆边上" },

  // ── blk6_17（OneEntry）：人民书店后邻（补） ──
  { asset: "phRoughWoodTable", x: -84.16, z: 119.06, ry: 0.12,
    note: "人民书店后邻的读书人家：粗木桌搬到院里，书就是在这张桌上一箱一箱装的" },
  { asset: "phChineseWoodStool", x: -83.84, z: 120.21, ry: -0.4,
    note: "同一户：桌边一只方凳，装到半夜的人坐过" },

  // ── blk9_13（ShopRow）：十字街西南角铺户（补） ──
  { asset: "shopPlaque", x: -41.84, z: 15.81, ry: 1.62,
    note: "十字街西南角铺户后院：卸下来的铺面门板靠在后院西墙上，铺子上了板才敢搬货" },
  { asset: "wineJarCluster", x: -41.78, z: 16.91, ry: -0.21, scale: 0.95,
