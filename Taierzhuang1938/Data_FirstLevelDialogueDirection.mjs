...
export const FIRST_LEVEL_DIALOGUE_DIRECTION = Object.freeze({
  ...
  CaptiveInterrogation: Scene(true, "交通壕里，日兵抓着受伤的川军俘虏按在沟壁上审问，翻译蹲在俘虏面前传话，几个人挤在一两米之内", {
    ...
    "04": P("breath", 0.25, { context: "眼神涣散，慢半拍才转过脸", delivery: "含糊的一声", pauseBeforeS: 0.9 }),
    "05": P("shout", 0.75, { delivery: "拔高嗓门吼" }),
    "06": P("shout", 0.85, { delivery: "不耐烦，压着翻译的话骂进来", offsetS: -0.25 }),
    "07": P("low", 0.35, { delivery: "虚弱但清楚，中间停一下", pauseBeforeS: 0.8, effort: { before: "喘两口气" } }),
    "08": P("shout", 0.8, { context: "皱眉扯住衣领", delivery: "逼问" }),
    "09": P("normal", 0.65, { delivery: "慌，谄媚地回报" }),
    "10": P("low", 0.4, { context: "抬了一下头", delivery: "喘着，一字一顿地骂", pauseBeforeS: 0.7 }),
    "11": P("low", 0.4, { context: "缓了一口气，嘴角带血", delivery: "平静的最后一句", pauseBeforeS: 1.2, emit: [{ id: "CaptiveLastWord", at: "end" }] }),
  }),
