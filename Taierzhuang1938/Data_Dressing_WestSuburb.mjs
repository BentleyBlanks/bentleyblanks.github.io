...
export const PLACEMENTS = Object.freeze([
  ...
  { asset: "militaryCrateOpen", x: -418.5, z: 75.2, ry: -0.4,
    note: "电灯厂南院：开盖的军用木箱" },
  { asset: "militaryCrateClosed", x: -417.2, z: 75.8, ry: 0.15,
    note: "电灯厂南院：第三只军用木箱，退到堆料块北边" },
  ...
  { asset: "clayWaterVat", x: -429.0, z: 65.6,
    note: "电灯厂西夹道：接锅炉用水的水缸（夹道北段，路堤块以北）" },
  { asset: "clayRoundVat", x: -428.9, z: 66.9, ry: 0.2,
    note: "电灯厂西夹道：第二口圆腹陶缸" },
  { asset: "battlefieldOpenBin", x: -422.0, z: 64.4, ry: 0.25,
    note: "厂房北墙外的空地：敞口铁桶，炉渣倒在里面" },
  { asset: "phFirewoodBranches", x: -428.2, z: 61.2, ry: 0.4,
    note: "电灯厂西夹道：引火柴枝，塞在路堤块与北墙之间" },
  ...
  { asset: "battlefieldMetalPole", x: -388.75, z: 66.8, ry: 1.6,
    note: "电灯厂东侧：顺东墙夹道躺的金属杆料（烟囱北边）" },
  { asset: "battlefieldMetalPole", x: -388.6, z: 70.6, ry: 1.54,
    note: "电灯厂东侧：第二根金属杆料，接在头一根北边" },
  { asset: "militaryCrateOpen", x: -390.8, z: 65.0, ry: 0.4,
    note: "电灯厂东侧：开盖的军用木箱" },
  { asset: "militaryCrateClosed", x: -388.6, z: 63.9, ry: -0.2,
    note: "电灯厂东侧：闭合的军用木箱，撂在东墙夹道口" },
  ...
  { asset: "firewoodPile", x: -422.7, z: -8.3, ry: 0.3,
    note: "西关大街铺面东头：后场的柴垛，离后墙半步" },
  ...
  { asset: "battlefieldTimberBeam", x: -413.2, z: -14.6, ry: 0.08,
  ...
  { asset: "militaryCrateClosed", x: -394.4, z: -13.2, ry: -0.15,
    note: "通信队门东：军用木箱" },
  { asset: "cart", x: -392.4, z: -11.9, ry: 0.28, scale: 0.9,
  ...
  // ---- 街南侧：货台边卸下的货 ----
  { asset: "marketBox03", x: -468.6, z: 16.1, ry: 0.2,
    note: "货台东侧：卸在台下的大木箱，篱外半步" },
  { asset: "marketBox02", x: -468.7, z: 17.4, ry: -0.3,
    note: "货台东侧：第二只木箱" },
  { asset: "marketCrate03", x: -468.7, z: 18.5, ry: 0.4,
    note: "货台东侧：板条箱" },
  { asset: "marketRiceSack01", x: -468.2, z: 19.6, ry: 0.6,
    note: "货台东侧：米袋" },
  { asset: "ryTimberStack", x: -468.7, z: 21.2, ry: 0.05,
    note: "货台东侧：木料堆" },
  ...
  { asset: "cart", x: -437.8, z: 10.2, ry: 0.62, scale: 0.9,
    note: "去电灯厂的斜路口：装到一半的大车，停在院墙外的空档" },
  { asset: "crate", x: -434.0, z: 11.2, ry: 0.2,
    note: "去电灯厂的斜路口：车边的木箱" },
  { asset: "marketBox02", x: -433.2, z: 12.4, ry: -0.35,
    note: "去电灯厂的斜路口：捆好的木箱" },
  { asset: "phWickerBasketLidded", x: -434.6, z: 12.2, ry: 0.4,
    note: "去电灯厂的斜路口：带盖竹篮" },
  ...
  // ---- 电灯厂西北的空场 ----
  { asset: "ryHayStack", x: -423.7, z: 29.6, ry: 0.2,
    note: "电灯厂西北空场：秸秆垛，让开农院东墙" },
  { asset: "ryFirewoodStack", x: -423.4, z: 31.4, ry: 0.1,
    note: "电灯厂西北空场：柴垛" },
  { asset: "phFirewoodBranches", x: -422.2, z: 30.4, ry: 0.5,
    note: "电灯厂西北空场：柴枝堆" },
  { asset: "ryChoppingBlock", x: -422.0, z: 28.8, ry: 0.3,
    note: "电灯厂西北空场：劈柴墩，柴堆南边" },
