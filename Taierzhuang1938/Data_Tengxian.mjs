...
export const WEST_SUBURB = {
  ...
  // 示意图中的长框是完整通讯院：北端天线场、中段机房、南端值班院共同占地。
  communications: { x: -410.5, z: -85, w: 47, d: 150 },
  // 电灯厂与交易所同样按整框读图；厂房本体保留周边作业余量，交易所含前铺后堂。
  powerPlant: { x: -410, z: 69, w: 40, d: 28, chimneyH: 22 },
  exchange: { x: -410, z: 132, w: 48, d: 62 },
  ...
  division122: { x: -366, z: -85, ry: Math.PI, w: 40, d: 150 },
