...
export const SKY_PRESETS = {
  ...
  dusk: {
    ...
    zenith: [0.30, 0.44, 0.82], horizon: [3.10, 1.62, 0.72], ground: [0.42, 0.34, 0.26],
    sunColor: [1.0, 0.54, 0.26], sunIntensity: 90, sunSize: 0.0042, glow: 2.6, glowSpread: 18,
    smoke: 0.50, smokeColor: [1.35, 0.92, 0.62], smokeHeight: 0.17, stars: 0.0,
    lightColor: 0xffb072, lightIntensity: 4.6,
    hemiSky: 0x6d7f9c, hemiGround: 0x4a3a28, hemiIntensity: 0.85,
    fogColor: 0x8a6a4c, fogNear: 20, fogFar: 175, envIntensity: 1.25,
    exposure: 0.62, godStrength: 0.85, bloom: 0.62, saturation: 0.98, contrast: 1.08,
  },
  // 3 月 24 日午后：日军攻北门，硝烟遮日
  smokyDay: {
    sunElevation: 38, sunAzimuth: 214,
    zenith: [0.92, 1.20, 1.72], horizon: [2.55, 2.42, 2.18], ground: [0.55, 0.48, 0.38],
    sunColor: [1.0, 0.92, 0.78], sunIntensity: 120, sunSize: 0.0030, glow: 1.35, glowSpread: 12,
    smoke: 0.72, smokeColor: [1.72, 1.60, 1.44], smokeHeight: 0.30, stars: 0.0,
    lightColor: 0xffe6c4, lightIntensity: 5.4,
    hemiSky: 0x9fb0c6, hemiGround: 0x5a4c3c, hemiIntensity: 0.95,
    fogColor: 0xa9a094, fogNear: 16, fogFar: 145, envIntensity: 1.15,
    exposure: 0.42, godStrength: 0.55, bloom: 0.48, saturation: 0.90, contrast: 1.07,
  },
  // 3 月 27 日—4 月 2 日：城内巷战，一半的天被火烧着
  burningStreet: {
    sunElevation: 21, sunAzimuth: 238,
    zenith: [0.52, 0.60, 0.86], horizon: [2.70, 1.62, 0.86], ground: [0.46, 0.36, 0.27],
    sunColor: [1.0, 0.70, 0.38], sunIntensity: 88, sunSize: 0.0034, glow: 2.2, glowSpread: 13,
    smoke: 0.88, smokeColor: [1.40, 1.02, 0.76], smokeHeight: 0.36, stars: 0.0,
    lightColor: 0xffbb80, lightIntensity: 4.2,
    hemiSky: 0x8a7f8c, hemiGround: 0x63472e, hemiIntensity: 0.88,
    fogColor: 0x8c6a50, fogNear: 11, fogFar: 105, envIntensity: 1.2,
    exposure: 0.50, godStrength: 1.15, bloom: 0.66, saturation: 0.94, contrast: 1.10,
  },
  // 4 月 3 日夜：敢死队
  night: {
    ...
    fogColor: 0x151a26, fogNear: 5, fogFar: 68, envIntensity: 1.4,
    exposure: 3.6, godStrength: 0.0, bloom: 0.85, saturation: 0.72, contrast: 1.14,
  },
  // 4 月 7 日拂晓：总反攻
  dawn: {
    sunElevation: 4.0, sunAzimuth: 88,
    zenith: [0.36, 0.52, 0.94], horizon: [3.40, 1.94, 1.02], ground: [0.44, 0.36, 0.28],
    sunColor: [1.0, 0.64, 0.36], sunIntensity: 105, sunSize: 0.0044, glow: 2.9, glowSpread: 15,
    smoke: 0.58, smokeColor: [1.55, 1.06, 0.74], smokeHeight: 0.21, stars: 0.04,
    lightColor: 0xffc890, lightIntensity: 5.0,
    hemiSky: 0x7e8eae, hemiGround: 0x50402f, hemiIntensity: 0.85,
    fogColor: 0x9a7458, fogNear: 18, fogFar: 165, envIntensity: 1.3,
    exposure: 0.52, godStrength: 1.35, bloom: 0.70, saturation: 0.96, contrast: 1.09,
  },
};
