...
export const MESHES = {
  ...
  ZhongZheng: {
    ...
    triangles: 556, meshBlocks: 2, nodes: 7, joints: 0,
    materials: ["steel", "wood"], mounts: WEAPON_MOUNTS,
    span: [0.0928, 0.1364, 1.1100], lengthM: 1.110,
    draws: { high: 2, medium: 2, low: 2 },
    note: "中正式。分段枪托 + 上护木 + 立框表尺 + 刺刀座。",
  },
  HanYang: {
    file: "HanYang.tzm.json", category: "weapon",
    triangles: 540, meshBlocks: 2, nodes: 7, joints: 0,
    materials: ["steel", "wood"], mounts: WEAPON_MOUNTS,
    span: [0.091, 0.137, 1.250], lengthM: 1.250,
  ...
  Zb26: {
    ...
    triangles: 520, meshBlocks: 2, nodes: 7, joints: 0,
    materials: ["steel", "wood"], mounts: WEAPON_MOUNTS,
    span: [0.168, 0.384, 1.165], lengthM: 1.165,
    draws: { high: 2, medium: 2, low: 2 },
