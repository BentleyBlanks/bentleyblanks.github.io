  ...
  L4_Chengqiang: [
    {
      ...
      from: [432, 17.5, -74], to: [424, 16.5, 26],
      look: [316, 8.5, -4], lookTo: [316, 8.5, 4], focalMm: 35,
    },
    {
  ...
  L1_Beishahe: [
    {
      ...
      from: [-608, 15, 118], to: [-632, 14, 86],
      look: [-700, 11, 32], focalMm: 40,
    },
    {
  ...
  L2_Dongguan: [
    {
      ...
      from: [594, 13, -96], to: [576, 12, -38],
      look: [452, 5.5, -46], focalMm: 40,
    },
    {
  ...
  L3_Fanji: [
    {
      ...
      from: [556, 6.5, -112], to: [538, 6.0, -84],
      look: [470, 2.6, -46], focalMm: 40,
    },
    {
      id: "TempleNight", title: "东关 · 寺院地", note: "寺院地：日方称之为「敌之有力据点」",
      from: [452, 18, 96], to: [436, 16.5, 66],
      look: [420, 5.5, -46], focalMm: 35,
    },
  ],
  ...
  L5_Shizijie: [
    {
      ...
      id: "Corridor", title: "东门里街 · 通视走廊", note: "东门里街往西推：十字街口 -> 西门里街 -> 西城门楼，一眼望穿",
      from: [196, 1.85, 2.2], to: [128, 1.80, 1.4],
      look: [-180, 2.2, 0], lookTo: [-288, 5.0, 0], focalMm: 50,
    },
    {
      id: "Yamen", title: "县衙", note: "县衙：城内唯一有实物可参照的建筑，明代大堂",
      from: [130, 23, -78], to: [156, 21, -62],
      look: [228, 6, -34], focalMm: 40,
    },
  ],
