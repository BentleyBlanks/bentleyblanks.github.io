...
export const OPENING = Object.freeze({
  ...
  zhouRest: {x:-36,z:-99},
  // The wounded gunner's exit is the access-trench polyline FRONT_SORTIE.zhouExit (ZhouGunExitRoute);
  // the 09.19 crate bypass points went with the old gun position.
