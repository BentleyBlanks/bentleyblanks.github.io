...
export const testDefs = {
  ...
  SubtitleTest: { file: "Script_SubtitleTest.mjs", desc: "对话字幕栈：叠放/留白/自绘补间（纯 Node，秒级）" },
...
export const domains = {
  ...
  hud: { label: "HUD/交互提示/目标识别", tests: ["HudPromptTest", "SubtitleTest", "HudPromptBrowserTest", "TargetInfoTest"] },
  ...
  cutscene: { label: "过场/车厢生活动作", tests: ["CutsceneControlTest", "SubtitleTest", "ActorPoseTest"] },
  render: {
    label: "渲染与合批自动契约",
...
const changedDomainRules = [
  ...
  { domain: "hud", pattern: /(Hud|Prompt|Reticle|Crosshair|Identify|Subtitle|Script_Input|index\.html)/i },
  ...
  { domain: "cutscene", pattern: /(Cutscene|Story|Subtitle|ActorPose|Train)/i },
