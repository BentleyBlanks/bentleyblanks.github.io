...
export const domains = {
  ...
  combat: {
    ...
    tests: ["DamageTest", "GunFeelTest", "FixedCenterAimTest", "ReticleCalibrationTest", "SprintCrosshairTest",
      "AdsSightTest", "SprintViewmodelTest", "SprintMeleeTest", "BayonetTest", "RangeTest"],
  },
  ...
  render: {
    label: "渲染与合批自动契约",
    tests: ["ActorBatchTest", "PropInstancingTest", "ProfilerTest", "ExternalPropAssetTest", "TownDressingTest", "EastSuburbBlocksTest", "EastSuburbNavTest", "WestDistrictCoverageTest", "WestSuburbBlocksTest", "WestStationTest", "DressingProbeTest"],
...
const changedDomainRules = [
  ...
  { domain: "render", pattern: /(Render|Shader|Material|Model|Landmark|Actor|Rigged|Vfx|Post|Lighting|Gi|Smoke|Outfield|PropBatch|PropStreaming|ExternalProps|Profiler|\.glsl|index\.html)/i },
