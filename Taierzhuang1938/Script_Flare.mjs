...
import { FLARE_SFX, FLARE_DEFAULTS, FLARE_PRESETS } from "./Data_Flares.mjs";
...
// 音效档案、默认值与两条预设全在 `Data_Flares.mjs`；这里 re-export，
// 老调用点与测试（断言从表里取期望值，不抄数）一行不改。
export { FLARE_SFX, FLARE_DEFAULTS, FLARE_PRESETS };
...
export class FlareDirector {
  ...
  LaunchFlare(spec = {}) {
    ...
    const flare = {
      ...
      label: String(cfg.label || T(cfg.labelKey || FLARE_DEFAULTS.labelKey)),
      from, at, groundY,
