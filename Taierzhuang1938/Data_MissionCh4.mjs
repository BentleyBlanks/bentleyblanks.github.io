...
export const VOICE_LINES = [
  // ── ① B 区集结院 ──────────────────────────────────────────────────────
  { key: "ch4_s124_01", who: "s124", delivery: "normal", dur: 0, text: "三七二旅的。" },
  { key: "ch4_heyoutian_01", who: "heyoutian", delivery: "normal", dur: 0, text: "哪一团？" },
  { key: "ch4_s124_02", who: "s124", delivery: "normal", dur: 0, text: "团还在不在都晓不得。" },
  { key: "ch4_luo_01", who: "luo", delivery: "normal", dur: 0, text: "那就莫报了。" },
  { key: "ch4_luo_02", who: "luo", delivery: "shout", dur: 0, text: "会打机枪的去右边。" },
  { key: "ch4_luo_03", who: "luo", delivery: "shout", dur: 0, text: "会甩手榴弹的守院墙。" },
  { key: "ch4_luo_04", who: "luo", delivery: "shout", dur: 0, text: "其余拿枪跟我。" },
  { key: "ch4_zhaodegui_01", who: "zhaodegui", delivery: "normal", dur: 0, text: "口令：长江。回令：泸州。" },
  { key: "ch4_xiaoqin_01", who: "xiaoqin", delivery: "normal", dur: 0, text: "线接通了。东街那头还有人。" },

  // ── ② 九十秒休整 ──────────────────────────────────────────────────────
  { key: "ch4_liuwencai_01", who: "liuwencai", delivery: "normal", dur: 0, text: "这碗稀的，跟洗锅水一个样。" },
  { key: "ch4_liuwencai_02", who: "liuwencai", delivery: "normal", dur: 0, text: "今晚这一锅，分不到三十个人……" },
  { key: "ch4_yaowa_01", who: "yaowa", delivery: "normal", dur: 0, text: "四川这阵是不是在下雨？" },
  { key: "ch4_zhaodegui_02", who: "zhaodegui", delivery: "normal", dur: 0, text: "该是。" },
  { key: "ch4_zhaodegui_03", who: "zhaodegui", delivery: "normal", dur: 0, text: "我屋头那面墙一到下雨就渗水。" },
  { key: "ch4_yaowa_02", who: "yaowa", delivery: "normal", dur: 0, text: "我妈一个人堵不住。" },
  // 「低声」——§5 原话如此，走 whisper 档
  { key: "ch4_heyoutian_02", who: "heyoutian", delivery: "whisper", dur: 0, text: "我姐屋头那棵桃树，也该开了。" },
  { key: "ch4_yaowa_03", who: "yaowa", delivery: "normal", dur: 0, text: "不是三个婆娘等你？" },
  { key: "ch4_heyoutian_03", who: "heyoutian", delivery: "normal", dur: 0, text: "扯把子的。" },
  { key: "ch4_heyoutian_04", who: "heyoutian", delivery: "normal", dur: 0, text: "哪有三个。" },
  { key: "ch4_heyoutian_05", who: "heyoutian", delivery: "normal", dur: 0, text: "就我姐给我写过信。" },
  { key: "ch4_s124_03", who: "s124", delivery: "normal", dur: 0, text: "真回得去，我以后再也不当兵。" },
  { key: "ch4_luo_05", who: "luo", delivery: "normal", dur: 0, text: "先把今晚熬过去。" },

  // ── ③ 半封回信（关内下半段；口述四句见过场那五条）──────────────────────
  { key: "ch4_heyoutian_06", who: "heyoutian", delivery: "whisper", dur: 0, text: "顺子，等哈也替我写两句。" },
  { key: "ch4_heyoutian_07", who: "heyoutian", delivery: "whisper", dur: 0, text: "就写我还活起。" },
  { key: "ch4_heyoutian_08", who: "heyoutian", delivery: "whisper", dur: 0, text: "别写我吐了。" },
  { key: "ch4_shunzi_01", who: "shunzi", delivery: "normal", dur: 0, text: "你自己给你姐写。" },
  { key: "ch4_heyoutian_09", who: "heyoutian", delivery: "normal", dur: 0, text: "老子认不到恁多字。" },
  { key: "ch4_xiaoqin_02", who: "xiaoqin", delivery: "shout", dur: 0, text: "东街喊支援！" },
  { key: "ch4_luo_06", who: "luo", delivery: "shout", dur: 0, text: "都起来！" },
  { key: "ch4_luo_07", who: "luo", delivery: "shout", dur: 0, text: "跟到我，一个跟一个。" },

  // ── ④ 黑暗接敌（整段 whisper）──────────────────────────────────────────
  { key: "ch4_yaowa_04", who: "yaowa", delivery: "whisper", dur: 0, text: "黑得看得到个鸭儿。" },
  { key: "ch4_luo_08", who: "luo", delivery: "whisper", dur: 0, text: "看不到就听。" },
  { key: "ch4_luo_09", who: "luo", delivery: "whisper", dur: 0, text: "枪口莫对到自己人。" },
  { key: "ch4_liuwencai_03", who: "liuwencai", delivery: "whisper", dur: 0, text: "刚才过去几个人？" },
  { key: "ch4_zhaodegui_04", who: "zhaodegui", delivery: "whisper", dur: 0, text: "莫数了。" },
  // 日方：text 必须是纯假名（汉字会被 seed-audio 当中文读）。汉字写法只作文档用：
  // 止まれ。音を立てるな。
  { key: "ch4_ija_gunso_01", who: "ija_gunso", delivery: "whisper", dur: 0, text: "とまれ。おとをたてるな。" },

  // ── ⑤ 第一枚照明弹 ────────────────────────────────────────────────────
  { key: "ch4_yaowa_05", who: "yaowa", delivery: "shout", dur: 0, text: "照明弹！" },
  { key: "ch4_luo_10", who: "luo", delivery: "shout", dur: 0, text: "贴墙！" },
  { key: "ch4_yaowa_06", who: "yaowa", delivery: "shout", dur: 0, text: "右边屋顶！" },
  { key: "ch4_heyoutian_10", who: "heyoutian", delivery: "shout", dur: 0, text: "妈卖批，亮了！" },
  { key: "ch4_luo_11", who: "luo", delivery: "shout", dur: 0, text: "打屋顶！莫站在亮处！" },
  // 照明弾を上げろ！
  { key: "ch4_ija_gunso_02", who: "ija_gunso", delivery: "shout", dur: 0, text: "しょうめいだんをあげろ！" },

  // ── ⑥ 黑暗转移 · 口令报错 ─────────────────────────────────────────────
  { key: "ch4_zhaodegui_05", who: "zhaodegui", delivery: "shout", dur: 0, text: "口令！" },
  { key: "ch4_s124_04", who: "s124", delivery: "shout", dur: 0, text: "……重庆！" },
  { key: "ch4_zhaodegui_06", who: "zhaodegui", delivery: "shout", dur: 0, text: "不对！趴倒！" },
  { key: "ch4_heyoutian_11", who: "heyoutian", delivery: "shout", dur: 0, text: "哪个自己人在乱打！" },
  { key: "ch4_s124_05", who: "s124", delivery: "shout", dur: 0, text: "先报位置！" },
  { key: "ch4_luo_12", who: "luo", delivery: "shout", dur: 0, text: "都闭嘴！左墙贴住！" },
  { key: "ch4_xiaoqin_03", who: "xiaoqin", delivery: "whisper", dur: 0, text: "线在我手头，脚下莫踩。" },

  // ── ⑦ 第二枚照明弹与白刃战 ────────────────────────────────────────────
  { key: "ch4_luo_13", who: "luo", delivery: "shout", dur: 0, text: "上刺刀！" },
  { key: "ch4_luo_14", who: "luo", delivery: "shout", dur: 0, text: "跟住自己人！" },
  { key: "ch4_luo_15", who: "luo", delivery: "shout", dur: 0, text: "莫让他们进后街！" },
  // 逃げるな！押し返せ！
  { key: "ch4_ija_gunso_03", who: "ija_gunso", delivery: "shout", dur: 0, text: "にげるな！おしかえせ！" },
  { key: "ch4_yaowa_07", who: "yaowa", delivery: "shout", dur: 0, text: "顺哥！左边！" },
  { key: "ch4_heyoutian_12", who: "heyoutian", delivery: "shout", dur: 0, text: "狗日的小日本！" },
  { key: "ch4_shangbing_01", who: "shangbing", delivery: "shout", dur: 0, text: "幺娃——！" },
  { key: "ch4_liuwencai_04", who: "liuwencai", delivery: "shout", dur: 0, text: "还有几个？还有几个？" },

  // ── ⑧ 罗班长救顺子 ────────────────────────────────────────────────────
  // 仕留めろ！
  { key: "ch4_ija_gunso_04", who: "ija_gunso", delivery: "shout", dur: 0, text: "しとめろ！" },
  { key: "ch4_luo_16", who: "luo", delivery: "shout", dur: 0, text: "起来！" },
  { key: "ch4_shunzi_02", who: "shunzi", delivery: "shout", dur: 0, text: "班长！" },
  // 中弹之后一律 weak（拉齐了就没救了，见 VOICE_DELIVERY_MIX 头注）
  { key: "ch4_luo_17", who: "luo", delivery: "weak", dur: 0, text: "……莫喊。" },

  // ── ⑨ 掩护罗班长撤离 ──────────────────────────────────────────────────
  { key: "ch4_shunzi_03", who: "shunzi", delivery: "shout", dur: 0, text: "莫松手！" },
  { key: "ch4_shunzi_04", who: "shunzi", delivery: "shout", dur: 0, text: "把班长拖进去！" },
  { key: "ch4_shunzi_05", who: "shunzi", delivery: "shout", dur: 0, text: "幺娃，抓稳！" },
  { key: "ch4_yaowa_08", who: "yaowa", delivery: "shout", dur: 0, text: "抓到起了！顺哥！" },
  { key: "ch4_shunzi_06", who: "shunzi", delivery: "shout", dur: 0, text: "哪个都不准松！" },
  { key: "ch4_heyoutian_13", who: "heyoutian", delivery: "shout", dur: 0, text: "屋顶！还有一个在屋顶！" },
  { key: "ch4_luo_18", who: "luo", delivery: "weak", dur: 0, text: "狗日的……小日本。" },
  { key: "ch4_shunzi_07", who: "shunzi", delivery: "normal", dur: 0, text: "莫说话。" },
  { key: "ch4_liuwencai_05", who: "liuwencai", delivery: "shout", dur: 0, text: "还有一条街！" },

  // ── ⑩ 回到 A 区主救护所 ───────────────────────────────────────────────
  { key: "ch4_yaowa_09", who: "yaowa", delivery: "shout", dur: 0, text: "担架兵！这边！" },
  { key: "ch4_junyi_01", who: "junyi", delivery: "shout", dur: 0, text: "放到那边！莫堵门！" },
  { key: "ch4_junyi_02", who: "junyi", delivery: "shout", dur: 0, text: "纱布！哪个手上有纱布？" },
  { key: "ch4_junyi_03", who: "junyi", delivery: "normal", dur: 0, text: "按到起，莫松。" },
  { key: "ch4_shunzi_08", who: "shunzi", delivery: "normal", dur: 0, text: "按到起了。" },
  { key: "ch4_junyi_04", who: "junyi", delivery: "normal", dur: 0, text: "侧门那头莫让人挤进来。" },

  // ── ⑪ 罗班长牺牲 ──────────────────────────────────────────────────────
  { key: "ch4_junyi_05", who: "junyi", delivery: "normal", dur: 0, text: "莫按了。" },
  { key: "ch4_shunzi_09", who: "shunzi", delivery: "normal", dur: 0, text: "不可能。" },
  { key: "ch4_shunzi_10", who: "shunzi", delivery: "shout", dur: 0, text: "他一路都还在骂！" },
  { key: "ch4_shunzi_11", who: "shunzi", delivery: "shout", dur: 0, text: "你再看一哈！" },
  { key: "ch4_shunzi_12", who: "shunzi", delivery: "shout", dur: 0, text: "日你先人，你再看！" },
  { key: "ch4_shunzi_13", who: "shunzi", delivery: "shout", dur: 0, text: "你莫乱说！" },
  { key: "ch4_yaowa_10", who: "yaowa", delivery: "whisper", dur: 0, text: "顺哥……" },
  { key: "ch4_shunzi_14", who: "shunzi", delivery: "normal", dur: 0, text: "你不是说打完再写吗？" },
  { key: "ch4_paizhang_01", who: "paizhang", delivery: "shout", dur: 0, text: "能拿枪的都到西街！" },
  { key: "ch4_shunzi_15", who: "shunzi", delivery: "normal", dur: 0, text: "枪给我。" },

  // ── 过场 1 · CS_Ch4_UnfinishedLetter（口述四句 + 收信）────────────────
  // 四句与 Texture/Tex_PaperLetter.png 上的四列逐字一致，改一个字就对不上贴图。
  { key: "ch4_luo_19", who: "luo", delivery: "normal", dur: 0, text: "娘的眼睛，请郎中再看一哈。" },
  { key: "ch4_luo_20", who: "luo", delivery: "normal", dur: 0, text: "欠王家的谷，等发饷再还。" },
  { key: "ch4_luo_21", who: "luo", delivery: "normal", dur: 0, text: "春妹的鞋莫做大了。" },
  { key: "ch4_luo_22", who: "luo", delivery: "normal", dur: 0, text: "等我回来……" },
  { key: "ch4_luo_23", who: "luo", delivery: "normal", dur: 0, text: "先收到。打完再写。" },

  // ── 过场 2 · CS_Ch4_AidStation ───────────────────────────────────────
  { key: "ch4_danjiayuan_01", who: "danjiayuan", delivery: "shout", dur: 0, text: "让一哈！让开！" },
  { key: "ch4_junyi_06", who: "junyi", delivery: "normal", dur: 0, text: "剪开。灯拿近点。" },
  { key: "ch4_shunzi_16", who: "shunzi", delivery: "normal", dur: 0, text: "再包一道。他刚才还在喘。" },
  { key: "ch4_junyi_07", who: "junyi", delivery: "normal", dur: 0, text: "没得脉了。" },
  { key: "ch4_danjiayuan_02", who: "danjiayuan", delivery: "shout", dur: 0, text: "这边还在出血！" },
];
