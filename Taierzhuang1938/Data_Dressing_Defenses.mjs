...
export const PLACEMENTS = Object.freeze([
  ...
  // 【实拍取证，2026-08-25】旧缺口局部 at=70 几乎整段落进东门 22 m 的门洞，
  // AddGateComplex 又把它盖成完整门台，所以画面上根本不存在独立炮击口。现在缺口
  // 移到东门北肩局部 at=15（世界 305,-15），同时避开 at=50.8 的马面；这一组仍是顺城街中段预备阵地，
  // 缺口断肩、瓦砾扇与贴口残砖由 Model_CityWallBreachPack 在 L4 精确布设。
  ...
  // 东墙缺口现已与门洞分开；下面这一组只承担门里工事，不再冒充缺口断面。
