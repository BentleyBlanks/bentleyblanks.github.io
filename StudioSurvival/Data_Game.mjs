...
export const DIRECTIVES = [
  {
    ...
    effects: {
      ...
      project: { scopeDebt: -5, technicalDebt: -5, bugs: -2, hype: 0, expectation: 0 },
      student: { stress: 0, morale: 0 },
      ai: { drift: 0 },
      anxiety: -3,
    },
  },
  {
    ...
    effects: {
      ...
      project: { scopeDebt: 0, technicalDebt: 0, bugs: 0, hype: 8, expectation: 1 },
      student: { stress: 0, morale: 0 },
      ai: { drift: 0 },
      anxiety: 1,
    },
  },
  {
    ...
    effects: {
      ...
      project: { scopeDebt: 4, technicalDebt: 4, bugs: 2, hype: 0, expectation: 0 },
      student: { stress: 7, morale: -3 },
      ai: { drift: 8 },
      anxiety: 5,
    },
  },
  {
    ...
    effects: {
      ...
      project: { scopeDebt: 0, technicalDebt: 0, bugs: 0, hype: 0, expectation: 0 },
      student: { stress: -14, morale: 6 },
      ai: { drift: -14 },
      anxiety: -6,
    },
  },
  {
    ...
    effects: {
      ...
      project: { scopeDebt: 0, technicalDebt: -14, bugs: -2, hype: 0, expectation: 0 },
      student: { stress: 0, morale: 0 },
      ai: { drift: 0 },
      anxiety: -1,
    },
  },
  {
    ...
    effects: {
      outputMultiplier: 0.82,
      project: { scopeDebt: -16, technicalDebt: -2, bugs: 0, hype: -2, expectation: 0 },
      student: { stress: 0, morale: 0 },
      ai: { drift: 0 },
      anxiety: -2,
    },
