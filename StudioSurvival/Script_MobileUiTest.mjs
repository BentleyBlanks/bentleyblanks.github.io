...
assert.match(html, /Style_Play\.css\?v=20260815f/, "mobile CSS changes must bypass the Pages cache");
assert.match(html, /Script_Play\.mjs\?v=20260815f/, "mobile input changes must bypass the Pages cache");
