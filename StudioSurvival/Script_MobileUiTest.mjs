...
assert.match(html, /Style_Play\.css\?v=20260816aa/, "UI changes must bypass the Pages cache");
assert.match(html, /Script_Play\.mjs\?v=20260816aa/, "gameplay changes must bypass the Pages cache");
assert.doesNotMatch(html, /Style_Play\.css\?v=20260816(?!aa)/, "the stylesheet cache-bust must stay unified");
assert.doesNotMatch(html, /Script_Play\.mjs\?v=20260816(?!aa)/, "the gameplay cache-bust must stay unified");
