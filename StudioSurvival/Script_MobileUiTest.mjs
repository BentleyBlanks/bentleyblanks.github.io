...
assert.match(html, /Style_Play\.css\?v=20260815j/, "world-route CSS changes must bypass the Pages cache");
assert.match(html, /Script_Play\.mjs\?v=20260815j/, "gameplay changes must bypass the Pages cache");
