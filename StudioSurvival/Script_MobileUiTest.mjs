...
assert.match(html, /Style_Play\.css\?v=20260815bd/, "UI changes must bypass the Pages cache");
assert.match(html, /Script_Play\.mjs\?v=20260815bd/, "gameplay changes must bypass the Pages cache");
assert.doesNotMatch(html, /Style_Play\.css\?v=20260815(?!bd)/, "the stylesheet cache-bust must stay unified");
assert.doesNotMatch(html, /Script_Play\.mjs\?v=20260815(?!bd)/, "the gameplay cache-bust must stay unified");
