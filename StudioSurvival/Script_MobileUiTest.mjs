...
assert.match(html, /Style_Play\.css\?v=20260815l/, "turn-control and goal-reveal CSS changes must bypass the Pages cache");
assert.match(html, /Script_Play\.mjs\?v=20260815l/, "gameplay changes must bypass the Pages cache");
