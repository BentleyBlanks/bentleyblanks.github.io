...
//
//   3. 连续接触声：已试听的 scoopDryStroke / scoopStickyStroke 固定为 0.4 秒 WAV，按实际滑动开启/停止；
...
export const SFX_SOURCES = [
  ...
  {id:'scoopStickyStroke',cue:'scoopStickyStroke',name:'耳勺黏蜡短刮 · 0.4秒',seconds:.4,category:'contact',material:'wet',contactKind:'wipe',variants:['试听定稿'],file:'AudioSfx_ScoopStickyStroke.wav',bakedOnly:true,prompt:'用户试听选定的 SeedAudio 第五版黏蜡短刮；黏连拖开，0.4秒。固定成品，不重新生音。'},
