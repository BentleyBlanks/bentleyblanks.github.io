...
try{
 ...
 p=await Probe();Check(Object.keys(ids).every(id=>p.rendering.toolLevels[id]===5),'五种工具购买升级后同步真实模型等级');
 ...
 console.log('PASS '+checks.length+' tactile detail checks; 40 full geometry contact audits');
