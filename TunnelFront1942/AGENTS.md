...
- **R5：玩法内核返工（本文档已按 R5 更新）。六条 P0：①第一幕真的把你打疼 ②抓丁改挂群众暴露
...
| A3《能打的地道》10T | 同图 | 民3 游1 联1 | 6 批 | 14 / 8 / 6 | 17 | +爆破 | 保全 ≥5、**洞粮 ≥12**、战斗 ≥1 | 换地方(≥2 个孔开过火)·六口·逼退 |
| A4《毒烟与水》12T | **有高低差**：西岗 2 / 村 1 / 东洼 0 | 民3 游2 联1 | 8 批 | 14 / 8 / 6 | 20 | 全开（烟·水·爆·攻入·刨·封） | 保全 ≥6、**洞粮 ≥12**、战斗 ≥1 | 换气(通气孔≥2 且零逼出)·一个不落(8)·高处(洞粮≥12) |
| A5《反扫荡》14T | **三村**（高家庄=区队部 / 李庄 / 马家河）+ T12 判定 | 民3 游2 联1 | 10 批 | 13+12+4 / 8 / 6 | 26 | 全开 | 保全 ≥8、存活村 ≥2、**洞粮 ≥18**、战斗 ≥1 | 村村相连(3 村贯通)·一个不落(10)·逼退 |

- **洞粮线一律高于「单个储粮洞的容量」**（R5 P0-6）：一个窖装不下，必须再挖一间；
  A5 的 18 担还高于两个起始窖的合计 16 担。原来 8 担一个洞就够，第三四回合就达标、后半局空转。
- A5 即败：区队部被驻剿纵队占满 2 回合 / 群众损失过半 / 战斗单位全灭（其余各幕只有最后一条）。
- **A1 的两条特调（R5 P0-1）**：`entranceThresholds` 把三个窖口调成 4/4/3 豆；
  `scriptedBreach: { turn: 6, telegraph, text }` = 第六回合**必然**撬开**人最多**的那个窖，
  窖内群众全部进代价簿（提前一回合电报）。玩家能改变的是「把人分散在哪几个窖里」，不是这一下会不会来。
