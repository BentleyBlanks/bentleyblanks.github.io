  ...
  { id: "PuppetContact", era: "Growth", turnRange: [8, 13], weight: 88, condition: { minStock: { intel: 8 } },
    ...
    options: [
      ...
      { id: "FamilyGuarantee", label: "给他家出一张保状，写明将来不追究", hint: "有的群众想不通：凭什么保汉奸的家。",
        effects: { puppetDefection: 0.2, alertDecay: 0.3, stockDelta: { cadre: -1 }, massDelta: -3 }, ledger: {} },
    ],
  ...
  { id: "GreatProduction", era: "Recovery", turnRange: [22, 26], weight: 100, condition: { once: true },
    ...
    options: [
      { id: "ReclaimWaste", label: "只开荒地和河滩，不动一分熟地", hint: "开的地薄，收的心实。",
        effects: { flatYield: { grain: 4 }, yieldBonus: { grain: 0.1 }, massDelta: 8, stockDelta: { labor: -20 }, unlockDoctrine: "DoctrineGreatProduction" }, ledger: {} },
      { id: "Workshops", label: "办纺织、造纸、榨油的作坊，换回来的比种出来的多", hint: "作坊有烟，烟能被看见。",
        effects: { flatYield: { labor: 3 }, yieldBonus: { labor: 0.12 }, stockDelta: { grain: 16, labor: -14 }, unlockDistrict: "ClothingWorkshop" }, ledger: {} },
  ...
  { id: "MutualAid", era: "Recovery", turnRange: [22, 27], weight: 95, condition: { minMass: 45 },
    ...
    options: [
      { id: "WorkPoints", label: "定工分制，年底找齐，账目公开", hint: "账清了，人就肯出力。",
        effects: { yieldBonus: { grain: 0.14, labor: 0.1 }, massDelta: 9, populationGrowth: 0.05, unlockDoctrine: "DoctrineMutualAid" }, ledger: {} },
      { id: "FamiliesFirst", label: "先保军属和缺劳力户，牲口优先给他们用", hint: "地种得不算最好，人心稳。",
        effects: { yieldBonus: { grain: 0.08 }, massDelta: 12, unrestDecay: 0.5, massGrowth: 0.15 }, ledger: {} },
