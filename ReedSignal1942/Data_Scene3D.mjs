...
export const ChapterVisuals = Object.freeze({
  ...
  tunnel: Object.freeze({
    ...
    accent: 0xe7a65b,
    water: 0x243536,
    camera: Object.freeze({ fov: 24, distance: 15.6, lift: 2.02, lookLift: 1.15 }),
    shots: Object.freeze([
      Object.freeze({ x0: 0, x1: 800, anchorX: 570, viewDistance: 15.4, lift: 2.0, reason: "枯井冷光切开土层" }),
      Object.freeze({ x0: 800, x1: 1740, viewDistance: 16.2, lift: 2.08, reason: "低顶支架与来烟前兆同框" }),
      Object.freeze({ x0: 1740, x1: 3020, viewDistance: 15.4, lift: 1.96, reason: "栓儿与窄井压近人物" }),
    ]),
  }),
  ferry: Object.freeze({
    sky: 0x2a4550,
    ...
    accent: 0xe1b56b,
    water: 0x3b656d,
    camera: Object.freeze({ fov: 23, distance: 17.2, lift: 2.75, lookLift: 1.1 }),
    shots: Object.freeze([
      Object.freeze({ x0: 0, x1: 1510, viewDistance: 17.4, lift: 2.8, reason: "六名孩子必须在同一构图内" }),
      Object.freeze({ x0: 1510, x1: 2300, anchorX: 1930, viewDistance: 15.4, lift: 2.62, reason: "母女交接与白布信号" }),
