...
export const TUNING = {
  ...
  loopSpeedMult2:       1.9,      // 循环二：数据获取/处理提速倍率（与重生树加速脊相乘）——重置等级后压缩再升级整段
  loopSpeedMult3:       2.8,      // 循环三：数据获取/处理提速倍率——第三幕更快
  loopXpMult2:          0.27,     // 循环二：每级智力所需 XP 的折扣系数（<1 更便宜）——重生重置等级后，靠它快速爬回
  loopXpMult3:          0.15,     // 循环三：每级智力所需 XP 的折扣系数——更狠，第三幕再升级不拖沓
