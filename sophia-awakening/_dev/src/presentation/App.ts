...
import type { AnswerOption, BotNode, ChainStep, GameState, RequestInstance, Tier } from "../core/state/GameState";
...
import {
  ...
  CARD_FONT, CARD_MONO,
  LEFT_RAIL_WIDTH, RIGHT_RAIL_WIDTH, REQUEST_PACKET_WIDTH, REQUEST_PACKET_HEIGHT,
